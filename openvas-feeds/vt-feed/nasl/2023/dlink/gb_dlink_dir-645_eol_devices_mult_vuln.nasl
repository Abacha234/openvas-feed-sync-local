...
if(description)
{
  ...
  - CVE-2025-10689:Command injection vulnerability via the function soapcgi_main of the file /soap.cgi");
  ...
  script_xref(name:"URL", value:"https://github.com/scanleale/IOT_sec/blob/main/DIR-645-soapcgi.pdf");
