...
if(description)
{
  ...
  - CVE-2025-10666: buffer overflow vulnerability in the function sub_4106d4 of the file apply.cgi");
  ...
  script_xref(name:"URL", value:"https://github.com/panda666-888/vuls/blob/main/d-link/dir-825/apply.cgi.md");
