...
if(description)
{
  ...
  script_cve_id("CVE-2022-34973", "CVE-2023-25279", "CVE-2023-25280", "CVE-2023-25281",
                "CVE-2023-25282", "CVE-2023-25283", "CVE-2024-48150", "CVE-2025-52079");

  script_name("D-Link DIR-820L Devices Multiple Vulnerabilities (2023 - 2025)");
  ...
  - CVE-2025-52079: Improper Access Control allows attackers to perform unverified password change
  via crafted POST request to /get_set.ccp.");
  ...
  script_xref(name:"URL", value:"https://github.com/namberino/cve/tree/main/CVE-2025-52079");
