...
if(description)
{
  ...
  - CVE-2025-60331: A buffer overflow vulnerability in the FillMacCloneMac parameter in the /
  EXCU_SHELL endpoint. This vulnerability allows attackers to cause a Denial of Service (DoS) via a
  crafted input.

  - CVE-2025-60332: A NULL pointer dereference in the SetWLanRadioSettings function allows
  attackers to cause a Denial of Service (DoS) via a crafted HTTP request.");
  ...
  script_xref(name:"URL", value:"https://github.com/z472421519/BinaryAudit/blob/main/PoC/BOF/DIR823G/FillMacCloneMac/FillMacCloneMac.md");
  script_xref(name:"URL", value:"https://github.com/z472421519/BinaryAudit/blob/main/PoC/NPD/DIR823G/SetWLanRadioSetting.md");
