...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2023-07-27 03:25:00 +0000 (Thu, 27 Jul 2023)");
  ...
  script_name("Cesanta Mongoose Web Server < 7.3.4 Prototype Pollution Vulnerability");
  ...
  script_tag(name:"summary", value:"Cesanta Mongoose Web Server is prone to a prototype pollution
  vulnerability.");
  ...
  script_tag(name:"affected", value:"Cesanta Mongoose Web Server prior to version 7.3.4.");
