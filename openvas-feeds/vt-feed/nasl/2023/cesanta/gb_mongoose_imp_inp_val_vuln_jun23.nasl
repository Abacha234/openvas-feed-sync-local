...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2023-07-10 16:03:00 +0000 (Mon, 10 Jul 2023)");
  ...
  script_name("Cesanta Mongoose Web Server < 7.10 Improper Input Validation Vulnerability");
  ...
  script_tag(name:"summary", value:"Cesanta Mongoose Web Server is prone to an improper input
  ...
  script_tag(name:"affected", value:"Cesanta Mongoose Web Server prior to version 7.10.");
