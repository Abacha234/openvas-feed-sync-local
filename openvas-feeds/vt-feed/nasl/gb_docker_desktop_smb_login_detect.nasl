...
if(description)
{
  ...
  script_name("Docker Desktop Detection (Windows SMB Login)");
  ...
  script_tag(name:"summary", value:"SMB login-based detection of Docker Desktop.");

  script_xref(name:"URL", value:"https://docs.docker.com/desktop/setup/install/windows-install/");
...
foreach key( key_list ) {
  foreach item( registry_enum_keys( key:key ) ) {
    ...
    set_kb_item( name:"docker/docker_desktop/detected", value:TRUE );
    set_kb_item( name:"docker/docker_desktop/smb-login/detected", value:TRUE );
