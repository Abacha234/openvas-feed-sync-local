...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2021-10-15 01:35:00 +0000 (Fri, 15 Oct 2021)");

  script_cve_id("CVE-2021-3111", "CVE-2021-22958", "CVE-2021-28145");
  ...
  - CVE-2021-3111: Stored cross-site scripting (XSS) on express entries H1 report

  - CVE-2021-22958: Server-side request forgery (SSRF)
