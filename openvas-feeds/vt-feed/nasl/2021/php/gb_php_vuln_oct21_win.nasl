...
if (description)
{
  ...
  script_name("PHP 5.3.7 - 7.3.31, 7.4.x < 7.4.25, 8.0.x < 8.0.12 Security Update (Oct 2021) - Windows");
  ...
  script_tag(name:"affected", value:"PHP versions 5.3.7 through 7.3.31, 7.4.x through 7.4.24 and
  8.0.x through 8.0.11.

  Note: While the referenced CVE is only listing PHP 7.3.x, 7.4.x and 8.0.x as affected the security
  research team is stating in the linked blog post that all versions down to 5.3.7 are affected.");

  script_tag(name:"solution", value:"Update to version 7.3.32 (not released yet), 7.4.25, 8.0.12
  or later.");
  ...
  script_xref(name:"URL", value:"https://www.ambionics.io/blog/php-fpm-local-root");
...
if (version_in_range(version: version, test_version: "5.3.7", test_version2: "7.3.31")) {
