...
if (description)
{
  ...
  script_name("PHP < 7.2.32, 7.3 < 7.3.20, 7.4 < 7.4.8 libcurl Vulnerability (May 2020) - Windows");
  ...
  script_tag(name:"summary", value:"PHP is prone to an information disclosure vulnerability in
  libcurl.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"PHP versions prior 7.2.32, 7.3 prior 7.3.20 and 7.4 prior to
  7.4.8.");
