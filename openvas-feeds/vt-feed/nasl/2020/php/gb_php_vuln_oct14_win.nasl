...
if (description)
{
  ...
  script_tag(name:"insight", value:"There is a use-after-free vulnerability in the add_post_var
  function in the Posthandler component of PHP.");

  script_tag(name:"impact", value:"The flaw might allow remote attackers to execute arbitrary code
...
if (version_in_range_exclusive(version: version, test_version_lo: "5.6.0", test_version_up: "5.6.1")) {
