...
if (description)
{
  ...
  script_name("PHP < 7.2.31, 7.3 < 7.3.18, 7.4 < 7.4.6 Multiple DoS Vulnerabilities (May 2020) - Windows");
  ...
  script_tag(name:"summary", value:"PHP is prone to two denial of service (DoS)
  vulnerabilities.");
  ...
  - CVE-2019-11048: Long filenames cause OOM and temp files to not be cleaned

  - Long variables in multipart/form-data cause OOM and temp files are not cleaned leading to denial
  of service.");

  script_tag(name:"affected", value:"PHP versions prior 7.2.31, 7.3 prior 7.3.18 and 7.4 prior to
  7.4.6.");
