...
if (description)
{
  ...
  script_tag(name:"insight", value:"If 'CHARSET_EBCDIC' is defined (usually, on systems with
  EBCDIC encoding support), an out-of-bounds read can occur using a malformed url-encoded string.");

  script_tag(name:"affected", value:"PHP versions prior 7.2.30, 7.3 prior 7.3.17 and 7.4 prior to
  7.4.5.");
