...
if (description)
{
  ...
  script_tag(name:"affected", value:"PHP prior to version 7.2.27, 7.3.x prior to 7.3.14 and 7.4.x
  prior to 7.4.2.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "7.3.0", test_version_up: "7.3.14")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.3.14", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range_exclusive(version: version, test_version_lo: "7.4.0", test_version_up: "7.4.2")) {
