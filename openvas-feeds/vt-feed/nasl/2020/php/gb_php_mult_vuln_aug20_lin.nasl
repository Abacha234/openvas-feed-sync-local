...
if (description)
{
  ...
  script_tag(name:"summary", value:"PHP is prone to a denial of service vulnerability in the
  phar_parse_zipfile function.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The phar_parse_zipfile function had use-after-free
  vulnerability because of mishandling of the actual_alias variable.");

  script_tag(name:"affected", value:"PHP versions prior 7.2.33, 7.3 prior 7.3.21 and 7.4 prior to
  7.4.9.");
