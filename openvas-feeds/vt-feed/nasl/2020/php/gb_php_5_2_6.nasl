...
if(description)
{
  ...
  script_cve_id("CVE-2007-4850", "CVE-2007-6039", "CVE-2008-0599", "CVE-2008-1384",
                "CVE-2008-2050", "CVE-2008-2051");
  ...
  script_tag(name:"affected", value:"PHP prior to version 5.2.6.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/28392");
