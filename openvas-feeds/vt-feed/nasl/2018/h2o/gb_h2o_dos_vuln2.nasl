...
if (description)
{
  ...
  script_tag(name:"summary", value:"H2O allows remote attackers to cause a denial of service (DoS)
  via format string specifiers in a template file via fastcgi, mruby, proxy, redirect or reproxy.");
