...
if(description)
{
  ...
  script_tag(name:"affected", value:"- PowerDNS Authoritative Server up to and including version
  3.4.10 and 4.0.1.

  - PowerDNS Recursor from 4.0.0 up to and including 4.0.3 versions.");

  script_tag(name:"solution", value:"- Update to version 3.4.11 or 4.0.2 respectively.
