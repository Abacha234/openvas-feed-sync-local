...
if(description)
{
  ...
  script_name("PowerDNS Authoritative Server Packet Cache Pollution DoS Vulnerability (2018-05)");
  ...
  script_tag(name:"affected", value:"PowerDNS Authoritative Server versions 4.1.0 through 4.1.4.");
