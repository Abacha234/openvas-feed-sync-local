...
if(description)
{
  ...
  script_name("PowerDNS Recursor Multiple DoS Vulnerabilities (2018-06, 2018-07)");
  ...
  script_tag(name:"affected", value:"PowerDNS Recursor versions 4.0.0 through 4.1.4.");

  script_tag(name:"solution", value:"Update to version 4.0.9, 4.1.5 or later.");
