...
if(description)
{
  ...
  script_name("PowerDNS Authoritative Server Buffer Overflow Vulnerability (2018-02)");
...
Authoritative Server, where replaying a specially crafted PCAP file can trigger a stack-based buffer overflow, leading to
...
dnsreplay is used.");
  ...
  script_tag(name:"affected", value:"PowerDNS Authoritative Server versions 4.0.0 through 4.1.1.");
