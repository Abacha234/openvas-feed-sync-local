...
if(description)
{
  ...
  script_name("PowerDNS Authoritative Server Zone Record DoS Vulnerability (2018-03)");
...
and is not always properly released if the record is malformed.");
  ...
  script_tag(name:"affected", value:"PowerDNS Authoritative Server versions 3.3.0 through 4.1.4.");

  script_tag(name:"solution", value:"Update to version 4.0.6, 4.1.5 or later.");
