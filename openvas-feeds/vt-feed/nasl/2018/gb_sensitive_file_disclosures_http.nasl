...
if(description)
{
  ...
  # nb: A CVSSv2 score above is used which is not necessarily the scoring attached to the CVEs
  #     below. This was done on purpose as some might have some too high or wrong scoring.
  ...
  script_dependencies("find_service.nasl", "no404.nasl", "webmirror.nasl",
                      "DDI_Directory_Scanner.nasl", "gb_drupal_http_detect.nasl",
                      "sw_magento_detect.nasl", "global_settings.nasl");
  ...
  - Web / application server configuration / password files (e.g. .htaccess, .htpasswd, web.config,
  web.xml, ...)
  ...
  - Editor / history files (e.g. .lesshst, .dbshell, ...)
...
genericfiles = make_array(
  ...
  # - https://www.codeigniter.com/user_guide/general/configuration.html
  # - https://www.warp.dev/terminus/docker-compose-env-file
  # - https://www.reddit.com/r/mongodb/comments/1628pca/database_url_environment_variable_not_found/
  #
  # Examples:
  ...
  #
  "/.env", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env_1", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env.backup", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env.bak", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env_baremetal", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env.development.local", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env.dev", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env.dev.local", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env.example", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env_hosted", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env.live", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env.local", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env_local", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env.old", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env.prod", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env.prod.local", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env.production", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env_production", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env.production.local", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env_sample", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env.save", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env.stage", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env_staging", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.env.www", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.local", 'Laravel config file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.production", 'Laravel config file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/.remote", 'Laravel config file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/staging2.env.example", 'Laravel config file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
  "/env.example", 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+',
...
foreach hn( hnlist ) {
  ...
  genericfiles["/env." + hn ] = 'Laravel/Codeigniter/Generic ".env" file present that may contain sensitive information like database credentials.#-#^(APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)|DB_(HOST|USERNAME|PASSWORD|DATABASE|URL)|(DATABASE|MAILER)_URL|PG_(USERNAME|PASSWORD|DATABASE))=.+';
}
