...
if (description)
{
  ...
  script_cve_id("CVE-2019-11044", "CVE-2019-11045", "CVE-2019-11046", "CVE-2019-11047",
  ...
  script_name("PHP Multiple Vulnerabilities (Dec 2019) - Windows");
  ...
  script_tag(name:"affected", value:"PHP versions 7.3.x prior to 7.3.13 and 7.4.x prior to
  7.4.1.");
