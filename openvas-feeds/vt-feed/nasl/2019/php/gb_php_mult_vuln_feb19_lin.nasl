...
if (description)
{
  ...
  script_cve_id("CVE-2016-10166", "CVE-2019-6977", "CVE-2019-9020", "CVE-2019-9021",
  ...
  script_name("PHP Multiple Vulnerabilities (Feb 2019) - Linux");
...
if (version_is_less(version: version, test_version: "5.6.40")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.6.40", install_path: location);
