...
if (version_is_less(version: version, test_version: "7.2.22")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.2.22", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "7.3", test_version2: "7.3.8")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.3.9", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}
