...
if(description)
{
  ...
  script_name("PowerDNS Authoritative Server 4.x < 4.2.0 DoS Vulnerability");
  ...
  script_tag(name:"affected", value:"PowerDNS Authoritative Server versions 4.x prior to 4.2.0.");
