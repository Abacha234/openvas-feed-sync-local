...
if(description)
{
  ...
  script_name("PowerDNS Authoritative Server Crafted Zone Records DoS Vulnerability (2019-04)");
  ...
  script_tag(name:"affected", value:"PowerDNS Authoritative Server before version 4.0.8 and 4.1.x up to and including 4.1.9.");

  script_tag(name:"solution", value:"Update to version 4.0.8, 4.1.10 or later.");
