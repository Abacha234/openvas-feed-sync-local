...
if(description)
{
  ...
  script_name("PowerDNS Authoritative Server NOTIFY Packets DoS Vulnerability (2019-05)");
  ...
  script_tag(name:"affected", value:"PowerDNS Authoritative Server before version 4.0.8 and 4.1.x up to and including 4.1.8.");

  script_tag(name:"solution", value:"Update to version 4.0.8, 4.1.9 or later.");
