...
if(description)
{
  ...
  script_tag(name:"affected", value:"PowerDNS Authoritative Server versions 4.1.10 and prior.

  Note: Although the advisory is stating that version 4.0.9 and 4.1.11 are not affected they still
  might be vulnerable if the mitigation steps are not applied.");
