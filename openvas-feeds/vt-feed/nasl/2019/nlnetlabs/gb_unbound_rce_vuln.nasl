...
if (description)
{
  ...
  script_tag(name:"insight", value:"Unbound contains a vulnerability that can cause shell code
  execution after receiving a specially crafted answer. This issue can only be triggered if unbound
  was compiled with '--enable-ipsecmod' support, and ipsecmod is enabled and used in the
  configuration.");

  script_tag(name:"affected", value:"Unbound DNS Resolver versions 1.6.4 through 1.9.4.");

  script_tag(name:"solution", value:"Update to version 1.9.5 or later or apply the provided
  patch.");
