...
if(description)
{
  ...
  script_version("2025-10-03T05:38:38+0000");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_tag(name:"last_modification", value:"2025-10-03 05:38:38 +0000 (Fri, 03 Oct 2025)");
...
if( login_banner ) {
  ...
  if( "Welcome to EMC Unity" >< login_banner ) {
    set_kb_item( name:"ssh/dell/unity/detected", value:TRUE );
    set_kb_item( name:"ssh/dell_unity/" + port + "/detected", value:TRUE );
    guess += '\n- Dell Unity';
  }

  # SBS 5.3.0
  if( login_banner =~ "SBS [0-9]+\.[0-9]+\.[0-9]+" && server_banner =~ "SSH-.+OpenSSH" ) {
    set_kb_item( name:"ssh/cisco/cyber_vision/detected", value:TRUE );
    set_kb_item( name:"ssh/cisco/cyber_vision/" + port + "/detected", value:TRUE );
