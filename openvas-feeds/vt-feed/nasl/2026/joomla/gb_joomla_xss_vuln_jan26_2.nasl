...
if(description)
{
  ...
  script_tag(name:"insight", value:"Lack of output escaping leads to a XSS vector in the pagebreak
  plugin.");

  script_tag(name:"affected", value:"Joomla! version 3.9.0 through 5.4.1 and 6.0.0 through
  6.0.1.");

  script_tag(name:"solution", value:"Update to version 5.4.2, 6.0.2 or later.");

  script_xref(name:"URL", value:"https://developer.joomla.org/security-centre/1017-20260102-core-xss-vector-in-the-pagebreak-plugin.html");
...
if (version_in_range(version: version, test_version: "3.9.0", test_version2: "5.4.1")) {
