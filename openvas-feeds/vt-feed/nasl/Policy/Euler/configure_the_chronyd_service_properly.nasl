...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 3. Running and Services: 3.6 Time Synchronization: 3.6.2 Configure the chronyd Service Properly (Recommendation)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 3. Running and Services: 3.6 Time Synchronization: 3.6.2 Configure the chronyd Service Properly (Recommendation)");
