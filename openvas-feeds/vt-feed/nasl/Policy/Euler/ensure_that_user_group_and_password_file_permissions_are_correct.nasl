...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.1 Users: 2.1.5 Ensure That User Group and Password File Permissions Are Correct (Requirement)");
  script_xref(name:"Policy", value:"EulerOS Virtual: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.1 Users: 2.1.5 Ensure That User Group and Password File Permissions Are Correct (Requirement)");
  script_xref(name:"Policy", value:"HCE Linux (Huawei Cloud EulerOS): openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.1 Users: 2.1.5 Ensure That User Group and Password File Permissions Are Correct (Requirement)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.1 Users: 2.1.5 Ensure That User Group and Password File Permissions Are Correct (Requirement)");
...
}else if(strstr(actual_value, '/etc/passwd root root -rw-r--r--') && strstr(actual_value, '/etc/shadow root root ----------') && strstr(actual_value, '/etc/group root root -rw-r--r--') && strstr(actual_value, '/etc/gshadow root root ----------') && strstr(actual_value, '/etc/passwd- root root -rw-r--r--') && strstr(actual_value, '/etc/shadow- root root ----------') && strstr(actual_value, '/etc/group- root root -rw-r--r--') && strstr(actual_value, '/etc/gshadow- root root ----------')){
  compliant = "yes";
