...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Virtual: EulerOS Virtual Linux Security Configuration (v1.0.0): 1. Initial deployment: 1.2 Software: 1.2.7 Do Not Install the rsync Service (Requirement)");
