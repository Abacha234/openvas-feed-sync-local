...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Virtual: EulerOS Virtual Linux Security Configuration (v1.0.0): 3. Running and Services: 3.2 Firewall: 3.2.4 Configure Proper Policies for OUTPUT of iptables (Recommendation)");
