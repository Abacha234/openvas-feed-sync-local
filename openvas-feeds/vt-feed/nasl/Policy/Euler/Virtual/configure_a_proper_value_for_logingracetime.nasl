...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Virtual: EulerOS Virtual Linux Security Configuration (v1.0.0): 3. Running and Services: 3.3 SSH: 3.3.16 Configure a Proper Value for LoginGraceTime (Recommendation)");
