...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Virtual: EulerOS Virtual Linux Security Configuration (v1.0.0): 2. Secure Access: 2.4 Access Control: 2.4.4 Ensure That Common Users Run Privileged Programs Using the sudo Command (Requirement)");
