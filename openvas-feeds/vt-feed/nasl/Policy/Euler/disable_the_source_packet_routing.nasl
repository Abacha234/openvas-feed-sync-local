...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 3. Running and Services: 3.5 Kernel: 3.5.13 Disable the Source Packet Routing (Requirement)");
  script_xref(name:"Policy", value:"EulerOS Virtual: openEuler Security Configuration Baseline (v1.0.0): 3. Running and Services: 3.5 Kernel: 3.5.13 Disable the Source Packet Routing (Requirement)");
  script_xref(name:"Policy", value:"HCE Linux (Huawei Cloud EulerOS): openEuler Security Configuration Baseline (v1.0.0): 3. Running and Services: 3.5 Kernel: 3.5.13 Disable the Source Packet Routing (Requirement)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 3. Running and Services: 3.5 Kernel: 3.5.13 Disable the Source Packet Routing (Requirement)");
...
}else if(actual_value =~ 'net.ipv4.conf.all.accept_source_route = 0\\s*net.ipv4.conf.default.accept_source_route = 0\\s*net.ipv6.conf.all.accept_source_route = 0\\s*net.ipv6.conf.default.accept_source_route = 0'){
  compliant = "yes";
