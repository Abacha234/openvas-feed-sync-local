...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 3. Running and Services: 3.2 Firewall: 3.2.12 Configure the Default Policies of nftables to DROP Properly (Recommendation)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 3. Running and Services: 3.2 Firewall: 3.2.12 Configure the Default Policies of nftables to DROP Properly (Recommendation)");
...
# nft add chain inet { type filter hook input priority 0\\<semicolon> policy drop\\<semicolon> }
# nft add chain inet { type filter hook output priority 0\\<semicolon> policy drop\\<semicolon> }
# nft add chain inet { type filter hook forward priority 0\\<semicolon> policy drop\\<semicolon> }
