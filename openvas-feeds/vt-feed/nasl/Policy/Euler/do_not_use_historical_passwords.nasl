...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.2 Passwords: 2.2.2 Do Not Use Historical Passwords (Requirement)");
  script_xref(name:"Policy", value:"EulerOS Virtual: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.2 Passwords: 2.2.2 Do Not Use Historical Passwords (Requirement)");
  script_xref(name:"Policy", value:"HCE Linux (Huawei Cloud EulerOS): openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.2 Passwords: 2.2.2 Do Not Use Historical Passwords (Requirement)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.2 Passwords: 2.2.2 Do Not Use Historical Passwords (Requirement)");
...
}else if(actual_value =~ '\\/etc\\/pam\\.d\\/system-auth:.*remember=([5-9]|[1-9][0-9]+)\\s*enforce_for_root' && actual_value =~ '\\/etc\\/pam\\.d\\/password-auth:.*remember=([5-9]|[1-9][0-9]+)\\s*enforce_for_root'){
  compliant = "yes";
