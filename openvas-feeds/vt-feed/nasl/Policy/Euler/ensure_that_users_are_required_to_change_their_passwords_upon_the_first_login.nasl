...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.2 Passwords: 2.2.11 Ensure That Users Are Required to Change Their Passwords Upon the First Login (Requirement)");
  script_xref(name:"Policy", value:"EulerOS Virtual: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.2 Passwords: 2.2.11 Ensure That Users Are Required to Change Their Passwords Upon the First Login (Requirement)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.2 Passwords: 2.2.11 Ensure That Users Are Required to Change Their Passwords Upon the First Login (Requirement)");
...
# ------------------------------------------------------------------
# CHECK : Check user in /etc/shadow
# ------------------------------------------------------------------

step_cmd = 'awk -F: \'/^'+user+':/ { print \\$3 }\' /etc/shadow';
