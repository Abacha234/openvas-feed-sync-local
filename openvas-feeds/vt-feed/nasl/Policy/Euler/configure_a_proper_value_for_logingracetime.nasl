...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 3. Running and Services: 3.3 SSH: 3.3.17 Configure a Proper Value for LoginGraceTime (Recommendation)");
  script_xref(name:"Policy", value:"HCE Linux (Huawei Cloud EulerOS): openEuler Security Configuration Baseline (v1.0.0): 3. Running and Services: 3.3 SSH: 3.3.17 Configure a Proper Value for LoginGraceTime (Recommendation)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 3. Running and Services: 3.3 SSH: 3.3.17 Configure a Proper Value for LoginGraceTime (Recommendation)");
...
expected_value = 'The output should be less than or equal to "60"';
...
}else if(int(actual_value) <= int(60)){
  compliant = "yes";
