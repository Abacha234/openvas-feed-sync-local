...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 4. Log Audit: 4.1 Audit: 4.1.17 Configure Audit Rules for Network Environment (Recommendation)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 4. Log Audit: 4.1 Audit: 4.1.17 Configure Audit Rules for Network Environment (Recommendation)");
...
-a always,exit -F arch=b32 -S setdomainname -S sethostname -k
-w /etc/hosts -p wa -k
-w /etc/issue -p wa -k
...
-a always,exit -F arch=b64 -S setdomainname -S sethostname -k
