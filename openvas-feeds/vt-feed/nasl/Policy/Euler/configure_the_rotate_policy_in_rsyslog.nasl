...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 4. Log Audit: 4.2 Rsyslog: 4.2.7 Configure the Rotate Policy in rsyslog (Requirement)");
  script_xref(name:"Policy", value:"EulerOS Virtual: openEuler Security Configuration Baseline (v1.0.0): 4. Log Audit: 4.2 Rsyslog: 4.2.7 Configure the Rotate Policy in rsyslog (Requirement)");
  script_xref(name:"Policy", value:"HCE Linux (Huawei Cloud EulerOS): openEuler Security Configuration Baseline (v1.0.0): 4. Log Audit: 4.2 Rsyslog: 4.2.7 Configure the Rotate Policy in rsyslog (Requirement)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 4. Log Audit: 4.2 Rsyslog: 4.2.7 Configure the Rotate Policy in rsyslog (Requirement)");
...
/etc/logrotate.d directory. Check and add the following configurations. indicates the rsyslog log
output path configured in the /etc/rsyslog.conf file. The two paths must be the same:
...
else if(check_result_1 && check_result_2 && check_result_3 && check_result_4 && check_result_5){
  compliant = "yes";
