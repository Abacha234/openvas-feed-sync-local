...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 1. Initial deployment: 1.2 Software: 1.2.6 Ensure That GPG Verification Is Configured for the Yum Repositories (Requirement)");
  script_xref(name:"Policy", value:"HCE Linux (Huawei Cloud EulerOS): openEuler Security Configuration Baseline (v1.0.0): 1. Initial deployment: 1.2 Software: 1.2.6 Ensure That GPG Verification Is Configured for the Yum Repositories (Requirement)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 1. Initial deployment: 1.2 Software: 1.2.6 Ensure That GPG Verification Is Configured for the Yum Repositories (Requirement)");
...
# rpm -ivh keyutils-.rpm
warning: keyutils-.rpm: Header V4 RSA/SHA256 Signature, key ID e2ec75bc: NOKEY
Verifying. ################################# [100%]
Preparing. ################################# [100%]
Updating / installing.
1:keyutils- ################################# [100%]
