...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 4. Log Audit: 4.1 Audit: 4.1.14 Configure Session Audit Rules (Recommendation)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 4. Log Audit: 4.1 Audit: 4.1.14 Configure Session Audit Rules (Recommendation)");
...
-w /var/run/utmp -p wa -k
-w /var/log/wtmp -p wa -k
-w /var/log/btmp -p wa -k
