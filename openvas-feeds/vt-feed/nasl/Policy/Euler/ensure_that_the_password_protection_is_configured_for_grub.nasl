...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.2 Passwords: 2.2.9 Ensure That the Password Protection Is Configured for GRUB (Requirement)");
  script_xref(name:"Policy", value:"EulerOS Virtual: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.2 Passwords: 2.2.9 Ensure That the Password Protection Is Configured for GRUB (Requirement)");
  script_xref(name:"Policy", value:"HCE Linux (Huawei Cloud EulerOS): openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.2 Passwords: 2.2.9 Ensure That the Password Protection Is Configured for GRUB (Requirement)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.2 Passwords: 2.2.9 Ensure That the Password Protection Is Configured for GRUB (Requirement)");
...
# echo <quote>GRUB2_PASSWORD=grub.pbkdf2.sha512.10000.xxxx<quote> > /boot/efi/EFI/openEuler/user.cfg

In legacy mode, run the following command to export the new password ciphertext to the
/boot/grub2/user.cfg file:

# echo <quote>GRUB2_PASSWORD=grub.pbkdf2.sha512.10000.xxxx<quote> > /boot/grub2/user.cfg
