...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 1. Initial deployment: 1.1 File Systems: 1.1.9 Ensure That Partitions That Do Not Need to Be Mounted with Devices Are Mounted Using nodev (Requirement)");
  script_xref(name:"Policy", value:"EulerOS Virtual: openEuler Security Configuration Baseline (v1.0.0): 1. Initial deployment: 1.1 File Systems: 1.1.9 Ensure That Partitions That Do Not Need to Be Mounted with Devices Are Mounted Using nodev (Requirement)");
  script_xref(name:"Policy", value:"HCE Linux (Huawei Cloud EulerOS): openEuler Security Configuration Baseline (v1.0.0): 1. Initial deployment: 1.1 File Systems: 1.1.9 Ensure That Partitions That Do Not Need to Be Mounted with Devices Are Mounted Using nodev (Requirement)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 1. Initial deployment: 1.1 File Systems: 1.1.9 Ensure That Partitions That Do Not Need to Be Mounted with Devices Are Mounted Using nodev (Requirement)");
