...
}else if((strstr(actual_value, 'IgnoreRhosts yes') && strstr(actual_value, 'HostbasedAuthentication no')) && (strstr(actual_value, 'PasswordAuthentication yes') || strstr(actual_value, 'PubkeyAuthentication yes'))){
  compliant = "yes";
