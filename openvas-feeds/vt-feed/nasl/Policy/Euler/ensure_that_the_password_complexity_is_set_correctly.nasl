...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.2 Passwords: 2.2.1 Ensure That the Password Complexity Is Set Correctly (Requirement)");
  script_xref(name:"Policy", value:"EulerOS Virtual: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.2 Passwords: 2.2.1 Ensure That the Password Complexity Is Set Correctly (Requirement)");
  script_xref(name:"Policy", value:"HCE Linux (Huawei Cloud EulerOS): openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.2 Passwords: 2.2.1 Ensure That the Password Complexity Is Set Correctly (Requirement)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.2 Passwords: 2.2.1 Ensure That the Password Complexity Is Set Correctly (Requirement)");
...
}else if(strstr(actual_value, 'minlen') && strstr(actual_value, 'minclass=3') && strstr(actual_value, 'enforce_for_root') && strstr(actual_value, 'retry=3') && strstr(actual_value, 'dcredit=0') && strstr(actual_value, 'ucredit=0') && strstr(actual_value, 'lcredit=0') && strstr(actual_value, 'ocredit=0')){
  compliant = "yes";
