...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 3. Running and Services: 3.5 Kernel: 3.5.11 Enable Reverse Path Filtering (Requirement)");
  script_xref(name:"Policy", value:"EulerOS Virtual: openEuler Security Configuration Baseline (v1.0.0): 3. Running and Services: 3.5 Kernel: 3.5.11 Enable Reverse Path Filtering (Requirement)");
  script_xref(name:"Policy", value:"HCE Linux (Huawei Cloud EulerOS): openEuler Security Configuration Baseline (v1.0.0): 3. Running and Services: 3.5 Kernel: 3.5.11 Enable Reverse Path Filtering (Requirement)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 3. Running and Services: 3.5 Kernel: 3.5.11 Enable Reverse Path Filtering (Requirement)");
...
}else if(actual_value =~ 'net.ipv4.conf.all.rp_filter\\s*=\\s*1\\s*net.ipv4.conf.default.rp_filter = 1'){
  compliant = "yes";
