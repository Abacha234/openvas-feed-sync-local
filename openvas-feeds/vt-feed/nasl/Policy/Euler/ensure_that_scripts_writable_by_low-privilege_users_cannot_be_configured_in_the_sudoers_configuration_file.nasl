...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.4 Access Control: 2.4.6 Ensure That Scripts Writable by Low-Privilege Users Cannot Be Configured in the sudoers Configuration File (Requirement)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.4 Access Control: 2.4.6 Ensure That Scripts Writable by Low-Privilege Users Cannot Be Configured in the sudoers Configuration File (Requirement)");
