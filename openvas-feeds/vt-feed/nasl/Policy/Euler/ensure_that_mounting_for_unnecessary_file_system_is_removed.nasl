...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 1. Initial deployment: 1.1 File Systems: 1.1.7 Ensure That Mounting for Unnecessary File System Is Removed (Requirement)");
  script_xref(name:"Policy", value:"EulerOS Virtual: openEuler Security Configuration Baseline (v1.0.0): 1. Initial deployment: 1.1 File Systems: 1.1.7 Ensure That Mounting for Unnecessary File System Is Removed (Requirement)");
  script_xref(name:"Policy", value:"HCE Linux (Huawei Cloud EulerOS): openEuler Security Configuration Baseline (v1.0.0): 1. Initial deployment: 1.1 File Systems: 1.1.7 Ensure That Mounting for Unnecessary File System Is Removed (Requirement)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 1. Initial deployment: 1.1 File Systems: 1.1.7 Ensure That Mounting for Unnecessary File System Is Removed (Requirement)");
...
mounting for those through configuration. The following file systems are not commonly
used:
...
<quote>.conf<quote>. The owner and owner group of the configuration file are both root, and the permission is
