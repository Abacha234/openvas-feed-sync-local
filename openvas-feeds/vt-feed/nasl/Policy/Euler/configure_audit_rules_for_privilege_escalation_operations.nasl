...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 4. Log Audit: 4.1 Audit: 4.1.7 Configure Audit Rules for Privilege Escalation Operations (Recommendation)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 4. Log Audit: 4.1 Audit: 4.1.7 Configure Audit Rules for Privilege Escalation Operations (Recommendation)");
...
}else if(actual_value == '-w /var/log/sudo.log -p wa -k sudoaction'){
  compliant = "yes";
