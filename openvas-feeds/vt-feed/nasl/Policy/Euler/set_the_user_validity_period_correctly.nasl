...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.1 Users: 2.1.12 Set the User Validity Period Correctly (Recommendation)");
  script_xref(name:"Policy", value:"EulerOS Virtual: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.1 Users: 2.1.12 Set the User Validity Period Correctly (Recommendation)");
  script_xref(name:"Policy", value:"HCE Linux (Huawei Cloud EulerOS): openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.1 Users: 2.1.12 Set the User Validity Period Correctly (Recommendation)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 2. Secure Access: 2.1 Users: 2.1.12 Set the User Validity Period Correctly (Recommendation)");
...
# grep "'+user+'" /etc/shadow | awk -F ":" \'{if(\\$8!=\\"\\"){print \\$8}}\'';
...
# ------------------------------------------------------------------
# CHECK : Check user validity period in /etc/shadow
# ------------------------------------------------------------------

step_cmd = 'grep "'+user+'" /etc/shadow | awk -F ":" \'{if(\\$8!=\\"\\"){print \\$8}}\'';
