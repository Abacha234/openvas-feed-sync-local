...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: openEuler Security Configuration Baseline (v1.0.0): 3. Running and Services: 3.2 Firewall: 3.2.9 Configure Proper Policies for OUTPUT of iptables (Recommendation)");
  script_xref(name:"Policy", value:"openEuler Baseline: openEuler Security Configuration Baseline (v1.0.0): 3. Running and Services: 3.2 Firewall: 3.2.9 Configure Proper Policies for OUTPUT of iptables (Recommendation)");
...
# iptables -A OUTPUT -p -s -d --sport -j ACCEPT
...
# ip6tables -A OUTPUT -p -s -d --sport -j ACCEPT
