...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://auroramail.wordpress.com/");
...
foreach dir (make_list_unique("/", "/afterlogic", "/aurora", "/webmail", "/webmailpro", http_cgi_dirs(port: port))) {
  ...
  if (("AfterLogic WebMail" >< res && "var EmptyHtmlUrl" >< res) ||
    ...
    set_kb_item(name: "afterlogic/aurora_webmail/detected", value: TRUE);
    set_kb_item(name: "afterlogic/aurora_webmail/http/detected", value: TRUE);
