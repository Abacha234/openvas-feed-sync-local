...
# nb:
# - More detailed OS detection covered in gb_greenbone_os_snmp_detect.nasl
# - As of GOS 24.10.6 the OPENVAS SCAN appliance is still reporting itself as "Greenbone Enterprise Appliance"
