...
if(description)
{
  ...
  script_name("Redis Server Default Password (TCP)");
  ...
  script_mandatory_keys("redis/tcp/detected", "redis/default_password");
...
security_message( port:port, data:"Redis Server is protected with the default password 'foobared'." );
exit( 0 );
