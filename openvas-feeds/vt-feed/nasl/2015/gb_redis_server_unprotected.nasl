...
if(description)
{
  ...
  script_dependencies("gb_redis_tcp_detect.nasl", "global_settings.nasl");
  script_mandatory_keys("redis/tcp/detected", "redis/no_password");
...
security_message( port:port, data:"Redis Server is not protected with a password." );
exit( 0 );
