...
if(description)
{
  ...
  script_name("PowerDNS Authoritative Server DoS Vulnerability (2015-03)");
  ...
  script_tag(name:"affected", value:"PowerDNS Authoritative Server versions 3.4.4 through 3.4.6.");
