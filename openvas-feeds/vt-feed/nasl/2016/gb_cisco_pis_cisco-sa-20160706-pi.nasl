...
if (description)
{
  ...
  script_name("Cisco Prime Infrastructure Administrative Web Interface HTML Injection Vulnerability (cisco-sa-20160706-pi)");
  ...
  Prime Infrastructure (PI) could allow an authenticated, remote attacker to execute arbitrary
  commands on the affected system and on the devices managed by the system.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability is due to improper user input validation.");

  script_tag(name:"impact", value:"An attacker could exploit this vulnerability by inserting
  crafting input into the affected fields of the web interface.");

  script_tag(name:"affected", value:"Cisco Prime Infrastructure version 3.1.0 and prior.");

  script_tag(name:"solution", value:"See the referenced vendor advisory for a solution.");

  script_xref(name:"URL", value:"https://sec.cloudapps.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20160706-pi");
