...
if(description)
{
  ...
  script_name("PowerDNS Authoritative Server AXFR Response DoS Vulnerability (Jul 2016)");
  ...
  script_tag(name:"affected", value:"PowerDNS Authoritative Server versions 3.4.9 and prior.");
