...
if(description)
{
  ...
  script_name("Oracle WebLogic Server Multiple RCE Vulnerabilities (cpuoct2016, cpujan2017)");
  ...
  script_xref(name:"URL", value:"https://www.oracle.com/security-alerts/cpujan2017.html");
