...
if(description)
{
  ...
  script_name("Knot DNS Server < 2.3.0 AXFR Response DoS Vulnerability");
  ...
  script_tag(name:"summary", value:"Knot DNS Server is prone to a denial of service (DoS)
  vulnerability.");
  ...
  script_tag(name:"affected", value:"Knot DNS versions prior to 2.3.0.");
