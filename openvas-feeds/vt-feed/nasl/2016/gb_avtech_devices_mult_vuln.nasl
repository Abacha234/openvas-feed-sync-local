...
if(description)
{
  ...
  script_cve_id("CVE-2016-15047", "CVE-2025-34050", "CVE-2025-34051", "CVE-2025-34053",
                "CVE-2025-34054", "CVE-2025-34055", "CVE-2025-34056", "CVE-2025-34065",
                "CVE-2025-34066");

  script_tag(name:"qod_type", value:"remote_vul");
  script_name("AVTECH Devices Multiple Vulnerabilities");

  script_tag(name:"summary", value:"AVTECH devices (IP camera/NVR/DVR) are prone to multiple
  vulnerabilities.");
  ...
  - CVE-2016-15047, CVE-2025-34050, CVE-2025-34051, CVE-2025-34053, CVE-2025-34054, CVE-2025-34055,
  CVE-2025-34056, CVE-2025-34065, CVE-2025-34066:
  ...
  Note: The authentication bypass vulnerability (CVE-2025-34065), covered by this active check,
  was actively exploited by the IoT botnet 'Reaper' in 2017.");
  ...
  script_xref(name:"URL", value:"https://vulncheck.com/advisories/avtech-ipcamera-nvr-dvr-mulitple-vulns");
  script_xref(name:"URL", value:"https://web.archive.org/web/20161029201749/https://github.com/ebux/AVTECH");
  script_xref(name:"URL", value:"https://web.archive.org/web/20240810225729/https://www.search-lab.hu/advisories/126-AVTech-devices-multiple-vulnerabilities");
  script_xref(name:"URL", value:"https://www.exploit-db.com/exploits/40500");
