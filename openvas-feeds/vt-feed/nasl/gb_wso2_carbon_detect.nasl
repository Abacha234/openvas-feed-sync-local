...
if (description)
{
  ...
  script_xref(name:"URL", value:"https://wso2.com/");
...
# <head><title>WSO2 Traffic Manager - About</title>
#
...
if (found) {
  ...
  else if (product == "Traffic Manager") {
    kb_name = "wso2_carbon_traffic_manager";
    cpe = "cpe:/a:wso2:traffic_manager";
    app = "WSO2 Traffic Manager";
  }

  else if (product == "Universal Gateway") {
    kb_name = "wso2_carbon_universal_gateway";
    cpe = "cpe:/a:wso2:universal_gateway";
    app = "WSO2 Universal Gateway";
  }
