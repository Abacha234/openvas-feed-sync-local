...
if(description)
{
  ...
  script_name("LibreOffice 7.2.x < 7.2.7, 7.3.x < 7.3.3 Multiple Vulnerabilities (Jul 2022) - Windows");
  ...
  script_tag(name:"affected", value:"LibreOffice 7.2.x through 7.2.7 and 7.3.x through 7.3.3.");
