...
if(description)
{
  ...
  script_name("LibreOffice 7.2.x < 7.2.7, 7.3.x < 7.3.2 Improper Certificate Validation Vulnerability (Jul 2022) - Windows");
  ...
  script_tag(name:"summary", value:"LibreOffice is prone to an improper certificate
  ...
  script_tag(name:"affected", value:"LibreOffice 7.2.x through 7.2.7 and 7.3.x through 7.3.2.");
