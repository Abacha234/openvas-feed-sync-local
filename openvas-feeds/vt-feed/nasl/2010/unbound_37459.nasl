...
if(description)
{
  ...
  script_name("Unbound DNS Server < 1.3.4 NSEC3 Signature Verification DNS Spoofing Vulnerability");
  ...
  script_xref(name:"URL", value:"https://web.archive.org/web/20210307173328/https://www.securityfocus.com/bid/37459/");
  ...
  responses so as to downgrade secure delegations to insecure status, which may aid in further
  attacks.");

  script_tag(name:"affected", value:"Unbound versions prior to 1.3.4.");
