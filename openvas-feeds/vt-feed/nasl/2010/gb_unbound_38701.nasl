...
if(description)
{
  ...
  script_name("Unbound < 1.4.3 'sock_list' Structure Allocation Remote DoS Vulnerability");
  ...
  script_xref(name:"URL", value:"https://web.archive.org/web/20210414023147/http://www.securityfocus.com/bid/38701");

  script_tag(name:"summary", value:"Unbound is prone to a remote denial of service (DoS)
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"Successful exploits may allow an attacker to crash the affected
  application, resulting in a denial-of-service condition. Given the nature of this issue, attackers
  may also be able to run arbitrary code, but this has not been confirmed.");

  script_tag(name:"affected", value:"Unbound versions prior to 1.4.3.");
