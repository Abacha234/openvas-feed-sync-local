...
if (description)
{
  ...
  within socket module. It uses memcpy to copy path from addr to s_un without checking addr length
  in case when AF_UNIX socket is used.");
...
if (version_is_less_equal(version: version, test_version: "5.3.5")) {
