...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834216");
  ...
  script_name("LibreOffice Improper Certificate Validation Vulnerability (Jul 2024) - Windows");
  ...
  script_tag(name:"insight", value:"The flaw exists when TLS certificate
