...
if (description)
{
  ...
  - CVE-2024-42383: A flaw which allows to write a NULL byte value beyond the memory space dedicated
  for the hostname field.

  - CVE-2024-42384, CVE-2024-42386: A flaw which allows an attacker to send an unexpected TLS packet
  and produce a segmentation fault on the application.

  - CVE-2024-42385: A flaw which allows to trigger an out-of-bound memory write if the PEM
  certificate contains unexpected characters.

  - CVE-2024-42387, CVE-2024-42388, CVE-2024-42389, CVE-2024-42390, CVE-2024-42391: A flaw which
  allows an attacker to send an unexpected TLS packet and force the application to read unintended
  heap memory space.

  - CVE-2024-42392: A flaw which allows to trigger an infinite loop bug if the input string contains
  unexpected characters.");

  script_tag(name:"affected", value:"Cesanta Mongoose Web Server probably version 7.14 only.");
