...
if (description)
{
  ...
  script_name("Piwigo <= 15.6.0 Multiple Vulnerabilities");
  ...
  Description) contains a stored cross-site scripting (XSS). It allows to perform a cross-site
  request forgery (CSRF) attack and change the email address of everyone who views the album.
  ...
  - CVE-2024-52701: A stored XSS vulnerability in the Configuration page");

  script_tag(name:"affected", value:"Piwigo version 15.6.0 and prior.");

  script_tag(name:"solution", value:"No known solution is available as of 16th October, 2025.
  Information regarding this issue will be updated once solution details are available.

  Note: For XSS vulnerabilities related to the admin backend the vendor is referring to a
  'allow_html_descriptions' configuration which could mitigate these flaws.");
  ...
  script_xref(name:"URL", value:"https://github.com/Piwigo/Piwigo/issues/2284");
  script_xref(name:"URL", value:"https://github.com/Piwigo/Piwigo/issues/2207#issuecomment-2976719455");
...
if( version_is_less_equal( version: version, test_version: "15.6.0" ) ) {
