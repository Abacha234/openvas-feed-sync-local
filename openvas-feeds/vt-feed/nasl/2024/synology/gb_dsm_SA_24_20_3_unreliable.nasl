...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.125549");
  ...
  script_name("Synology DiskStation Manager (DSM) File Disclosure Vulnerability (Synology-SA-24:20) - Unreliable Remote Version Check");
  ...
  script_tag(name:"summary", value:"Synology DiskStation Manager (DSM) is prone to a file disclosure
  vulnerability.");
...
# 7.1.1-42962-7 and not 7.1.1-42962), there will be 2 VTs with different qod_type.
...
# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.125548
if ((version =~ "^7\.1\.1" && (revcomp(a: version, b: "7.1.1-42962") < 0)) ||
    (version =~ "^7\.2" && version !~ "^7\.2\.[12]" && (revcomp(a: version, b: "7.2-64570") < 0)) ||
    (version =~ "^7\.2\.1" && (revcomp(a: version, b: "7.2.1-69057") < 0)) ||
