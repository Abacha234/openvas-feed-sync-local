...
if(description)
{
  ...
  script_name("ProFTPD < 1.3.5e, 1.3.6 < 1.3.6rc5 Local Security Bypass Vulnerability");
  ...
  script_tag(name:"summary", value:"ProFTPD server is prone to local security bypass
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The ProFTPD controls whether the home directory of a user could
  contain a symbolic link through the AllowChrootSymlinks configuration option, but checks only the
  last path component when enforcing AllowChrootSymlinks.");
  ...
  script_tag(name:"affected", value:"ProFTPD prior to version 1.3.5e and 1.3.6 prior to
  1.3.6rc5.");

  script_tag(name:"solution", value:"Update to version 1.3.5e, 1.3.6rc5 or later.");
...
if (version_is_less(version: version, test_version: "1.3.5e") ||
    version_in_range(version: version, test_version: "1.3.6", test_version2: "1.3.6.rc4")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "1.3.5e / 1.3.6rc5");
