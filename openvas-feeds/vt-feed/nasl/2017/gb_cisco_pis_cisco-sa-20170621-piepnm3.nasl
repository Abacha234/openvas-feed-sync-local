...
if (description)
{
  ...
  script_name("Cisco Prime Infrastructure Reflected Cross-Site Scripting Vulnerability (cisco-sa-20170621-piepnm3)");
  ...
  Prime Infrastructure (PI) could allow an unauthenticated, remote attacker to conduct a reflected
  ...
  script_xref(name:"URL", value:"https://sec.cloudapps.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20170621-piepnm3");
