...
if(description)
{
  ...
  script_name("PowerDNS Authoritative (Auth) Server DoS Vulnerability (2015-01)");

  script_tag(name:"summary", value:"PowerDNS Authoritative (Auth) Server is prone to a denial of
  ...
  3.3.x before 3.3.3, and 3.4.x before 3.4.5.");

  script_tag(name:"solution", value:"Update to version 3.3.3, 3.4.5 or later.");
