...
if(description)
{
  ...
  script_name("PowerDNS Recursor Label Decompression DoS Vulnerability (2015-01)");
  ...
  and 3.7.x before 3.7.3.");

  script_tag(name:"solution", value:"Update to version 3.6.4, 3.7.3 or later.");
