...
if(description)
{
  ...
  script_mandatory_keys("powerdns/recursor_or_authoritative_server/detected");
  ...
  script_tag(name:"summary", value:"The version of the PowerDNS product on the remote host has
  reached the End of Life (EOL) and should not be used anymore.");

  script_tag(name:"vuldetect", value:"Checks if an EOL version is present on the target host.");

  script_tag(name:"impact", value:"An EOL version of a PowerDNS product is not receiving any
  ...
  script_tag(name:"solution", value:"Update the version of the PowerDNS product on the remote host
...
if( ret = product_reached_eol( cpe:cpe, version:version ) ) {
  ...
  if( "recursor" >< cpe )
    ...
    app = "PowerDNS Authoritative Server";
  else
    app = "PowerDNS";
