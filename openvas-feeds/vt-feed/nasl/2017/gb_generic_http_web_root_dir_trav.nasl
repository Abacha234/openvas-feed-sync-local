...
if(description)
{
  ...
  script_cve_id("CVE-2010-10012", # nb: See https://www.exploit-db.com/exploits/15861
                ...
                "CVE-2025-61666" # nb: https://github.com/traccar/traccar/security/advisories/GHSA-hprc-rph8-fj87 (Unauthenticated and arbitrary files can be read)
               );
