...
if(description)
{
  ...
  script_name("Oracle WebLogic Server 'Servlet Runtime' RCE Vulnerability (cpuapr2017)");
  ...
  script_tag(name:"insight", value:"The flaw exists due to some unspecified error in the 'Servlet
  Runtime' sub-component within Oracle WebLogic Server.");

  script_tag(name:"impact", value:"Successful exploitation will allow attackers to execute arbitrary
  code.");

  script_tag(name:"affected", value:"Oracle WebLogic Server versions 12.1.3.0, 12.2.1.0, 12.2.1.1
  and 12.2.1.2.");
  ...
  script_xref(name:"URL", value:"https://www.oracle.com/security-alerts/cpuapr2017.html");
