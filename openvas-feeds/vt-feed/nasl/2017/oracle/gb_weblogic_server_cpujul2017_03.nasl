...
if(description)
{
  ...
  script_name("Oracle WLS 'Web Container' And 'WLS Core' Components Multiple Vulnerabilities (cpujul2017, cpuoct2018)");
  ...
  'Web Container' and 'WLS Core' components of the application.");
  ...
  script_tag(name:"solution", value:"Apply the appropriate patch from the vendor. Please see the
