...
if(description)
{
  ...
  script_tag(name:"solution", value:"Update to version 5.33.6163 or later.");
  ...
  script_xref(name:"URL", value:"https://blog.avast.com/update-to-the-ccleaner-5.33.6162-security-incident");
...
if(ccVer == "5.33.6162")
{
  report = report_fixed_ver(installed_version:ccVer, fixed_version:"5.33.6163");
