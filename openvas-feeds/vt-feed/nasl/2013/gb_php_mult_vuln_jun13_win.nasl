...
if (description)
{
  ...
  - Heap-based overflow in 'php_quot_print_encode' function in 'ext/standard/quot_print.c' script.

  - Integer overflow in the 'SdnToJewish' function in 'jewish.c' in the Calendar component.");

  script_tag(name:"impact", value:"Successful exploitation allows attackers to execute arbitrary
  code or cause denial of service condition via crafted arguments.");

  script_tag(name:"affected", value:"PHP prior to version 5.3.26 and 5.4.x prior to 5.4.16.");

  script_tag(name:"solution", value:"Update to version 5.4.16, 5.3.26 or later.");
...
if (version_is_less(version: version, test_version: "5.3.26")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.3.26", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "5.4.0", test_version2: "5.4.15")) {
