...
if (description)
{
  ...
  script_name("PHP < 5.3.15 Security Bypass Vulnerability - Windows");
  ...
  script_tag(name:"insight", value:"Flaw in SQLite functionality allows attackers to bypass the
  open_basedir protection mechanism.");

  script_tag(name:"impact", value:"Successful exploitation could allow attackers to bypass certain
  security restrictions.");

  script_tag(name:"affected", value:"PHP prior to version 5.3.15.");

  script_tag(name:"solution", value:"Update to version 5.3.15 or later.");
