...
if(description)
{
  ...
  script_cve_id("CVE-2012-10026");
  script_name("WordPress Asset Manager Plugin 0.2 'upload.php' Arbitrary File Upload Vulnerability - Active Check");
  ...
  script_xref(name:"URL", value:"https://web.archive.org/web/20150106144832/http://www.opensyscom.fr:80/Actualites/wordpress-plugins-asset-manager-shell-upload-vulnerability.html");
  script_xref(name:"URL", value:"https://www.vulncheck.com/advisories/wordpress-plugin-asset-manager-php-file-upload");
  script_xref(name:"URL", value:"https://www.exploit-db.com/exploits/18993");
  script_xref(name:"URL", value:"https://packetstorm.news/files/id/113285");
  ...
  script_tag(name:"summary", value:"WordPress Asset Manager Plugin is prone to a file upload
  vulnerability.");

  script_tag(name:"insight", value:"The flaw is due to the
  wp-content/plugins/asset-manager/upload.php script allowing to upload files with arbitrary
  extensions to a folder inside the webroot. This can be exploited to execute arbitrary PHP code by
  ...
  script_tag(name:"affected", value:"WordPress Asset Manager Plugin version 0.2 and probably
  prior.");
