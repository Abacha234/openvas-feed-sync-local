...
if (description)
{
  ...
  script_name("PHP <= 5.4.3 RCE Vulnerability - Windows");
  ...
  script_tag(name:"insight", value:"The flaw is due to an error in the 'com_print_typeinfo()'
  function, which allows remote attackers to execute arbitrary code via crafted arguments that
  trigger incorrect handling of COM object VARIANT types.");

  script_tag(name:"impact", value:"Successful exploitation could allow remote attackers to execute
  arbitrary code in the context of a webserver. Failed attempts will likely result in denial of
  service conditions.");
