...
if(description)
{
  ...
  script_cve_id("CVE-2012-10027");
  script_name("WordPress WP-Property Plugin 1.35.0 'uploadify.php' Arbitrary File Upload Vulnerability - Active Check");
  ...
  script_xref(name:"URL", value:"https://web.archive.org/web/20150103065650/http://www.opensyscom.fr:80/Actualites/wordpress-plugins-wp-property-shell-upload-vulnerability.html");
  script_xref(name:"URL", value:"https://www.vulncheck.com/advisories/wordpress-plugin-wp-property-php-file-upload");
  script_xref(name:"URL", value:"https://www.exploit-db.com/exploits/18987");
  script_xref(name:"URL", value:"https://packetstorm.news/files/id/113274");
  ...
  script_tag(name:"summary", value:"WordPress WP-Property Plugin is prone to a file upload
  vulnerability.");

  script_tag(name:"insight", value:"The flaw is due to the
  wp-content/plugins/wp-property/third-party/uploadify/uploadify.php script allowing to upload files
  with arbitrary extensions to a folder inside the webroot. This can be exploited to execute
  ...
  script_tag(name:"affected", value:"WordPress WP-Property Plugin version 1.35.0 and probably
  prior.");
