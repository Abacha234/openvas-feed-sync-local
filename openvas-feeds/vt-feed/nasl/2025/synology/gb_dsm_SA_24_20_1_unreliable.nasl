...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.125545");
  ...
  script_name("Synology DiskStation Manager (DSM) RCE Vulnerability (Synology-SA-24:20) - Unreliable Remote Version Check");
...
# 7.2-64570-4 and not 7.2-64570), there will be 2 VTs with different qod_type.
...
# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.125544
