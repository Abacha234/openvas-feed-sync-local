...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.125539");
  ...
  script_name("Synology DiskStation Manager (DSM) Authentication Bypass Vulnerability (Synology-SA-25:14) - Unreliable Remote Version Check");
...
if (version =~ "^7\.2\.2-72806" && (revcomp(a: version, b: "7.2.2-72806-5") < 0)) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.2.2-72806-5");
  security_message(port: 0, data: report);
  exit(0);
}

if (version =~ "^7\.3\.1-86003" && revcomp(a: version, b: "7.3.1-86003-1") < 0) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.3.1-86003-1");
  security_message(port: 0, data: report);
  exit(0);
}

# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.125538
if ((version =~ "^7\.2\.2" && (revcomp(a: version, b: "7.2.2-72806") < 0)) ||
    (version =~ "^7\.3" && (revcomp(a: version, b: "7.3.1-86003") < 0)))
  exit(0);
