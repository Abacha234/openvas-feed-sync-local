...
if (description)
{
  ...
  script_name("Synology DiskStation Manager (DSM) Multiple Vulnerabilities (Synology_SA_24_21) - Active Check");
  ...
  script_tag(name:"affected", value:"Synology DiskStation Manager (DSM) with Synology Drive Server
  prior to version 3.0.4-12699, 3.2.1-23280, 3.5.0-26085 or 3.5.1-26102 installed.");
