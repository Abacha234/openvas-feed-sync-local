...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.125568");
  ...
  script_name("Apache HTTP Server 2.4.30 - 2.4.65 Integer Overflow Vulnerability - Windows");
  ...
  script_tag(name:"summary", value:"Apache HTTP Server is prone to an integer overflow
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"An integer overflow in the case of failed ACME certificate
  renewal leads, after a number of failures (~30 days in default configurations), to the
  backoff timer becoming 0. Attempts to renew the certificate then are repeated without
  delays until it succeeds.");

  script_tag(name:"affected", value:"Apache HTTP Server version 2.4.30 through 2.4.65.");
...
if (version_in_range(version: version, test_version: "2.4.30", test_version2: "2.4.65")) {
