...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836877");
  script_version("2025-11-25T05:40:35+0000");
  script_cve_id("CVE-2025-13499");
  ...
  script_name("Wireshark Security Update (wnpa-sec-2025-06) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Wireshark version 4.4.0 through 4.4.10 and
  4.6.0 on Mac OS X.");

  script_tag(name:"solution", value:"Update to version 4.4.11 or 4.6.1 or later.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"executable_version");
  script_xref(name:"URL", value:"https://www.wireshark.org/security/wnpa-sec-2025-06.html");
...
if(version_in_range(version: vers, test_version: "4.4.0", test_version2: "4.4.10")) {
  fix = "4.4.11";
}
