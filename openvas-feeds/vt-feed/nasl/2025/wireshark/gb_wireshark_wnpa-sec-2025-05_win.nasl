...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836872");
  ...
  script_name("Wireshark Security Update (wnpa-sec-2025-05) - Windows");
  ...
  script_tag(name:"affected", value:"Wireshark version 4.6.0 on Windows.");
