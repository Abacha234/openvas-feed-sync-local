...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836858");
  ...
  script_name("Mozilla Firefox ESR Security Update (mfsa_2025-88) - Mac OS X");
...
if(version_in_range_exclusive(version:vers, test_version_lo:"140.0", test_version_up:"140.5")) {
