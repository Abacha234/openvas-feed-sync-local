...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/buglist.cgi?bug_id=1966083");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/buglist.cgi?bug_id=1970095");

  script_tag(name:"summary", value:"The remote host is missing an update for Mozilla Firefox, announced via the advisory MFSA2025-47.");
...
An integer overflow was present in OrderedHashTable used by the JavaScript engine");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox versions prior to 139.0.4.");
