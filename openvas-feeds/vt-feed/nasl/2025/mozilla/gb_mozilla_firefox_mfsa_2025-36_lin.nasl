...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/buglist.cgi?bug_id=1966612");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/buglist.cgi?bug_id=1966614");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for Mozilla Firefox, announced via the advisory MFSA2025-36.");
...
An attacker was able to perform an out-of-bounds read or write on a JavaScript object by confusing array index sizes.");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox versions prior to 138.0.4.");
