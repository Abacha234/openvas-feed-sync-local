...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/buglist.cgi?bug_id=1951554");

  script_tag(name:"summary", value:"The remote host is missing an update for Mozilla Firefox, announced via the advisory MFSA2025-25.");
...
to cause memory corruption, potentially leading to an exploitable condition.");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox versions prior to 137.0.2.");
