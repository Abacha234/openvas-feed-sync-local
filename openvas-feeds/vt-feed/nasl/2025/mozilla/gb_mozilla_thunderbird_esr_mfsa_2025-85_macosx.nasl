...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836775");
  ...
  script_name("Mozilla Thunderbird ESR Security Update (mfsa_2025-85) - Mac OS X");
...
if(version_is_less(version:vers, test_version:"140.4")) {
