...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836936");
  ...
  script_name("Mozilla Firefox Security Update (mfsa_2025-98) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox prior to version 146.0.1 on
  Mac OS X.");

  script_tag(name:"solution", value:"Update to version 146.0.1 or later.");
...
if(version_is_less(version:vers, test_version:"146.0.1")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"146.0.1", install_path:path);
