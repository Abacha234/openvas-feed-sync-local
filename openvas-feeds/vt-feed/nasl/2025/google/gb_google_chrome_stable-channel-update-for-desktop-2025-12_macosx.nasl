...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836882");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop-2025-12) - Mac OS X");
  ...
  143.0.7499.40 on Mac OS X");

  script_tag(name: "solution", value:"Update to version 143.0.7499.40/41 or later.");
...
if(version_is_less(version:vers, test_version:"143.0.7499.40")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"143.0.7499.40/41", install_path:path);
