...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836698");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_30-2025-09) - Linux");
  ...
  141.0.7390.54 on Linux");

  script_tag(name: "solution", value:"Update to version 141.0.7390.54 or later.");
...
if(version_is_less(version:vers, test_version:"141.0.7390.54")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"141.0.7390.54", install_path:path);
