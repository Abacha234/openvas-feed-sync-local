...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836742");
  ...
  script_name("Microsoft .NET Framework Remote Code Execution Vulnerability (KB5066746)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5066746");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5066746");
