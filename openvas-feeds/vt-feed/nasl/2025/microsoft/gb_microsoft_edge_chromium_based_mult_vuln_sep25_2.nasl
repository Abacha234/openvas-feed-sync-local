...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836690");
  ...
  script_tag(name:"creation_date", value:"2025-09-30 16:27:49 +0530 (Tue, 30 Sep 2025)");
  script_name("Microsoft Edge (Chromium-Based) < 140.0.3485.94 Multiple Vulnerabilities (Sep 2025)");
  ...
  script_tag(name:"affected", value:"Microsoft Edge (Chromium-Based) prior to version 140.0.3485.94.");
...
if(version_is_less(version:vers, test_version:"140.0.3485.94")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"140.0.3485.94", install_path:path);
