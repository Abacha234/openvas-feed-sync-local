...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836727");
  ...
  script_name("Microsoft Access 2016 Multiple Vulnerabilities (KB5002720)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002720.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002720");
...
if(version_in_range(version:vers, test_version:"16.0", test_version2:"16.0.5507.0999")) {
  report = report_fixed_ver(file_checked:"msaccess.exe",
           file_version:vers, vulnerable_range:"16.0 - 16.0.5507.0999");
