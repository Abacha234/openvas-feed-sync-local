...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836756");
  ...
  script_name("Remote Desktop Client < 1.2.6599.0 RCE Vulnerability (Oct 2025) - Windows");
  ...
  version 1.2.6599.0 on Windows");

  script_tag(name:"solution", value:"Update to public version 1.2.6599.0 or later.");
...
if(version_is_less(version:vers, test_version:"1.2.6599.0")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:'1.2.6599.0', install_path:path);
