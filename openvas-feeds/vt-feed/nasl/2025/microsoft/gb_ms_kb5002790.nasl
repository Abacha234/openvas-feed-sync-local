...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836725");
  script_version("2025-10-17T18:17:07+0000");
  script_cve_id("CVE-2025-59238");
  ...
  script_tag(name:"severity_date", value:"2025-10-14 17:16:05 +0000 (Tue, 14 Oct 2025)");
  script_tag(name:"creation_date", value:"2025-10-15 09:40:01 +0530 (Wed, 15 Oct 2025)");
  script_name("Microsoft PowerPoint 2016 RCE Vulnerability (KB5002790)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002790");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002790");
...
foreach key(key_list) {
  ...
  if(exeVer =~ "^16\." && version_is_less(version:exeVer, test_version:"16.0.5522.1000")) {
    report = report_fixed_ver(file_checked:offPath + "\ppcore.dll", file_version:exeVer, vulnerable_range:"16.0 - 16.0.5522.999");
