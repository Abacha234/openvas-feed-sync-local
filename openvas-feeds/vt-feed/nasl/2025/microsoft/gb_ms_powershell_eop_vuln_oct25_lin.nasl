...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836753");
  ...
  script_name("Microsoft PowerShell Elevation of Privilege Vulnerability (Oct 2025) - Linux");
  ...
  and 7.5 prior to 7.5.4 on Linux.");
