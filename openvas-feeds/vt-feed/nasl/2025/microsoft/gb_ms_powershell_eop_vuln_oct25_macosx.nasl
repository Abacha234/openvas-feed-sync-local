...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836754");
  ...
  script_name("Microsoft PowerShell Elevation of Privilege Vulnerability (Oct 2025) - Mac OS X");
  ...
  and 7.5 prior to 7.5.4 on Mac OS X.");
