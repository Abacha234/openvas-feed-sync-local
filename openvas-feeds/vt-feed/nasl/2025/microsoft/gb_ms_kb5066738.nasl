...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836737");
  ...
  script_name("Microsoft .NET Framework Remote Code Execution Vulnerability (KB5066738)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5066738");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5066738");
    ...
    foreach item (registry_enum_keys(key:key))
    {
      ...
      if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
      {
        foreach item (registry_enum_keys(key:key))
        {
          ...
          if(dllVer)
          {
            if(version_in_range(version:dllVer, test_version:"2.0.50727.5700", test_version2:"2.0.50727.9066"))
            {
              vulnerable_range = "2.0.50727.5700 - 2.0.50727.9066";
              break;
            }
            else if(version_in_range(version:dllVer, test_version:"4.6", test_version2:"4.7.4136"))
            {
              vulnerable_range = "4.6 - 4.7.4136" ;
              break;
            }
            else if(version_in_range(version:dllVer, test_version:"4.8", test_version2:"4.8.4797"))
            {
