...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.837006");
  script_version("2025-12-11T05:46:19+0000");
  script_cve_id("CVE-2025-62552");
  ...
  script_tag(name:"severity_date", value:"2025-12-09 18:16:00 +0000 (Tue, 09 Dec 2025)");
  script_tag(name:"creation_date", value:"2025-12-10 05:56:14 +0000 (Wed, 10 Dec 2025)");
  script_name("Microsoft Access 2016 RCE Vulnerability (KB5002812)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002812.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002812");
...
if(officeVer =~ "^16\.")
{
  ...
  foreach key(key_list)
  {
    ...
    if(propath)
    {
      ...
      if(offexeVer =~ "^16\." && version_is_less(version:offexeVer, test_version:"16.0.5530.1000"))
      {
        report = report_fixed_ver(file_checked:offPath + "\acecore.dll",
                 file_version:offexeVer, vulnerable_range:"16.0 - 16.0.5530.999");
