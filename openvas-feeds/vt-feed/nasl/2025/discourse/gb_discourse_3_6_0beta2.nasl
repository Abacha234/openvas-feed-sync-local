...
if(description)
{
  ...
  script_name("Discourse 3.6.x < 3.6.0.beta1 Multiple Vulnerabilities");
  ...
  script_tag(name:"affected", value:"Discourse versions 3.6.0.beta prior to 3.6.0.beta1.");

  script_tag(name:"solution", value:"Update to version 3.6.0.beta1 or later.");
  ...
  script_xref(name:"URL", value:"https://meta.discourse.org/t/3-6-0-beta1-color-palette-editing-user-fields-on-sign-up-themeable-site-setting-discovery-images-with-google-ai-and-reliable-drafts/383509");
...
if (version_in_range_exclusive(version: version, test_version_lo: "3.6.0.beta", test_version_up: "3.6.0.beta1")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "3.6.0.beta1", install_path: location);
