...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://osv.dev/vulnerability/PSF-2025-5");
  script_xref(name:"URL", value:"https://osv.dev/vulnerability/PSF-2025-6");
  script_xref(name:"URL", value:"https://osv.dev/vulnerability/PSF-2025-7");
  script_xref(name:"URL", value:"https://osv.dev/vulnerability/PSF-2025-8");
  script_xref(name:"URL", value:"https://osv.dev/vulnerability/PSF-2025-9");
