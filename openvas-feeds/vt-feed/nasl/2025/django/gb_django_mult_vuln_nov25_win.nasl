...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.155712");
  script_version("2025-11-07T05:40:09+0000");
  script_tag(name:"last_modification", value:"2025-11-07 05:40:09 +0000 (Fri, 07 Nov 2025)");
  script_tag(name:"creation_date", value:"2025-11-06 04:08:23 +0000 (Thu, 06 Nov 2025)");
  script_tag(name:"cvss_base", value:"9.4");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:N");

  script_cve_id("CVE-2025-64458", "CVE-2025-64459");

  script_tag(name:"qod_type", value:"executable_version");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Django 4.x < 4.2.26, 5.0.x < 5.1.14, 5.2.x < 5.2.8 Multiple Vulnerabilities - Linux");
  ...
  - CVE-2025-64458: Denial of service DoS in HttpResponseRedirect and
  HttpResponsePermanentRedirect

  - CVE-2025-64459: SQL injection (SQLi) via _connector keyword argument in QuerySet and Q
  objects");
