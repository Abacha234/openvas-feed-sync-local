...
if(description)
{
  ...
  - CVE-2025-10779: Stack-based buffer overflow via the function sub_402280 of the file /HNAP1/.");
  ...
  script_xref(name:"URL", value:"https://github.com/scanleale/IOT_sec/blob/main/DCS-935L-1.pdf");
  script_xref(name:"URL", value:"https://github.com/scanleale/IOT_sec/blob/main/DCS-935L-2.pdf");
