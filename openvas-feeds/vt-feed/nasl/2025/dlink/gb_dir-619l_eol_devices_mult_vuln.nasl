...
if(description)
{
  ...
  - CVE-2025-55599: Buffer overflow via formWlanSetup

  - CVE-2025-55602: Buffer overflow via formSysCmd

  - CVE-2025-55611: Buffer overflow via formLanguageChange");
  ...
  script_xref(name:"URL", value:"https://github.com/wudipjq/my_vuln/blob/main/D-Link6/vuln_65/65.md");
  script_xref(name:"URL", value:"https://github.com/wudipjq/my_vuln/blob/main/D-Link6/vuln_79/79.md");
  script_xref(name:"URL", value:"https://github.com/wudipjq/my_vuln/blob/main/D-Link6/vuln_80/80.md");
