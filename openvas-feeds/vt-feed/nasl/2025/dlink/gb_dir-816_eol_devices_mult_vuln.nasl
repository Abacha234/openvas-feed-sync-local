...
if(description)
{
  ...
  - CVE-2025-61577: Stack overflow via the statuscheckpppoeuser parameter in the dir_setWanWifi
  function.");
  ...
  script_xref(name:"URL", value:"https://github.com/Flechao1/iot-vuln/blob/main/dlink-816-b05.md");
  script_xref(name:"URL", value:"https://github.com/peris-navince/founded-0-days/blob/main/Dlink/816/dir_setWanWifi/1.md");
