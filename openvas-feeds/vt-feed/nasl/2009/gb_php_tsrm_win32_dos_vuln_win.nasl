...
if (description)
{
  ...
  script_name("PHP < 5.2.11 DoS Vulnerability - Windows");
  ...
  script_tag(name:"insight", value:"An error occurs in popem 'API' function in TSRM/tsrm_win32.c,
  when running on certain Windows operating systems. It can be caused via a crafted 'e' or 'er'
  string in the second argument (aka mode), possibly related to the '_fdopen' function in the
  ...
  script_tag(name:"affected", value:"PHP prior to version 5.2.11 on Windows.");
