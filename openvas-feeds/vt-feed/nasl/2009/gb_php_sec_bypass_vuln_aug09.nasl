...
if(description)
{
  ...
  'safe_mode_exec_dir' and 'open_basedir' restrictions for certain functions. This can be caused via
  the exec, system, shell_exec, passthru, or popen functions, possibly involving pathnames such as
  'C:' drive notation.");
