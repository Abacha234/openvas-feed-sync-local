...
if(description)
{
  ...
  script_tag(name:"summary", value:"SMB login-based detection of LibreOffice.");
  ...
  foreach item (registry_enum_keys(key:key)){
    ...
    if("LibreOffice" >< officeName){
      ...
      if(!isnull(officeVer)){
        ...
        # Used in gb_libreoffice_portable_wmi_login_detect.nasl to avoid doubled detections.
