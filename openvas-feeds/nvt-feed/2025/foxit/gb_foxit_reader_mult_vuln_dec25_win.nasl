...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836938");
  ...
  script_name("Foxit Reader Multiple Vulnerabilities (Dec 2025) - Windows");
  ...
  script_tag(name:"affected", value:"Foxit Reader version 2025.2.1.33197 and
  prior on Windows.");

  script_tag(name:"solution", value:"Update to version 2025.3 or later.");
...
if(version_is_less(version:vers, test_version:"2025.3")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"2025.3", install_path:path);
