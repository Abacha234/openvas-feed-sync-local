...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836862");
  ...
  script_name("Microsoft Edge (Chromium-Based) Heap Corruption Vulnerability (Nov 2025)");
  ...
  script_tag(name:"affected", value:"Microsoft Edge (Chromium-Based) prior to version 142.0.3595.80.");
...
if(version_is_less(version:vers, test_version:"142.0.3595.80")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"142.0.3595.80", install_path:path);
