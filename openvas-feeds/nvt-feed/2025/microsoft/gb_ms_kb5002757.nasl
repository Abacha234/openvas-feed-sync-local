...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836728");
  script_version("2025-10-17T18:17:07+0000");
  script_cve_id("CVE-2025-59232", "CVE-2025-59235");
  ...
  script_name("Microsoft Office 2016 Multiple Vulnerabilities (KB5002757)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002757");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002757");
...
if(officeVer =~ "^16\.") {
  ...
  foreach key(key_list)
  {
    ...
    if(propath) {
      ...
      if(offexeVer =~ "^16\." && version_is_less(version:offexeVer, test_version:"16.0.5522.1000")) {
        report = report_fixed_ver(file_checked:offPath + "\graph.exe",
                 file_version:offexeVer, vulnerable_range:"16.0 - 16.0.5522.999");
