...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836937");
  script_version("2025-12-24T05:46:55+0000");
  script_cve_id("CVE-2025-14766", "CVE-2025-14765");
  ...
  script_name("Microsoft Edge (Chromium-Based) < 143.0.3650.96 Multiple Vulnerabilities (Dec 2025)");
  ...
  script_tag(name:"affected", value:"Microsoft Edge (Chromium-Based) prior to version 143.0.3650.96.");
...
if(version_is_less(version:vers, test_version:"143.0.3650.96")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"143.0.3650.96", install_path:path);
