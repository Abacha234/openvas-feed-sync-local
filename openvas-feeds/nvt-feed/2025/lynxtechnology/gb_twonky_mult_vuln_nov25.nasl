...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.155826");
  script_version("2025-11-26T05:40:08+0000");
  script_tag(name:"last_modification", value:"2025-11-26 05:40:08 +0000 (Wed, 26 Nov 2025)");
  script_tag(name:"creation_date", value:"2025-11-20 05:59:18 +0000 (Thu, 20 Nov 2025)");
  script_tag(name:"cvss_base", value:"7.6");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:H/Au:N/C:C/I:C/A:C");
  script_tag(name:"severity_vector", value:"CVSS:3.1/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_tag(name:"severity_origin", value:"NVD");
  script_tag(name:"severity_date", value:"2025-11-25 19:36:13 +0000 (Tue, 25 Nov 2025)");

  script_cve_id("CVE-2025-13315", "CVE-2025-13316");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"NoneAvailable");

  script_name("Twonky Server <= 8.5.2 Multiple Vulnerabilities - Version Check");
  ...
  - CVE-2025-13315: Authentication bypass in web service API

  - CVE-2025-13316: Hardcoded encryption keys across installations");
...
if (version_is_less_equal(version: version, test_version: "8.5.2")) {
