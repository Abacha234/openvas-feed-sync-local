...
if(description)
{
  ...
  script_name("LibreOffice Arbitrary Code Execution vulnerability (Aug 2025) - Windows");

  script_tag(name:"summary", value:"LibreOffice is prone to an arbitrary code execution
  vulnerability.");
  ...
  script_tag(name:"affected", value:"LibreOffice prior to version 7.2.6 and
