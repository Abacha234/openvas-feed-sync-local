...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.125564");
  ...
  script_cve_id("CVE-2025-58098");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Apache HTTP Server < 2.4.66 SSI Vulnerability - Linux");
  ...
  script_tag(name:"summary", value:"Apache HTTP Server is prone to a Server Side Includes (SSI)
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Apache HTTP Server with SSI enabled and mod_cgid (but not
