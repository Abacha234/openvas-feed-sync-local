...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.4390.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:4390-1)");
 ...
 * Miscellaneous improvements and bug fixes.");
  ...
  script_tag(name:"affected", value:"'rhino' package(s) on openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rhino", rpm:"rhino~1.7.15.1~150200.12.7.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rhino-demo", rpm:"rhino-demo~1.7.15.1~150200.12.7.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rhino-engine", rpm:"rhino-engine~1.7.15.1~150200.12.7.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rhino-javadoc", rpm:"rhino-javadoc~1.7.15.1~150200.12.7.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rhino-runtime", rpm:"rhino-runtime~1.7.15.1~150200.12.7.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
