...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.3743.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:3743-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libxslt-python", rpm:"libxslt-python~1.1.32~150000.3.28.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
