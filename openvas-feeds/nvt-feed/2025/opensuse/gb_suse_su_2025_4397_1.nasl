...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.4397.1");
  ...
  script_tag(name:"creation_date", value:"2025-12-18 04:15:23 +0000 (Thu, 18 Dec 2025)");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:4397-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:4397-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20254397-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1254551");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-December/023540.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaThunderbird' package(s) announced via the SUSE-SU-2025:4397-1 advisory.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"MozillaThunderbird", rpm:"MozillaThunderbird~140.6.0~150200.8.248.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaThunderbird-translations-common", rpm:"MozillaThunderbird-translations-common~140.6.0~150200.8.248.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaThunderbird-translations-other", rpm:"MozillaThunderbird-translations-other~140.6.0~150200.8.248.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
