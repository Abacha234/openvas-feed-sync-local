...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.3950.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:3950-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"runc", rpm:"runc~1.2.7~150000.80.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
