...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.3744.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:3744-1)");
 ...
 * ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'aws-cli, local-npm-registry, python-boto3, python-botocore, python-coverage, python-flaky, python-pluggy, python-pytest, python-pytest-cov, python-pytest-html, python-pytest-metadata, python-pytest-mock' package(s) on openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"aws-cli", rpm:"aws-cli~1.33.26~150400.34.7.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python311-boto3", rpm:"python311-boto3~1.34.138~150400.27.7.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python311-botocore", rpm:"python311-botocore~1.34.144~150400.41.7.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python311-coverage", rpm:"python311-coverage~7.6.10~150400.12.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python311-flaky", rpm:"python311-flaky~3.8.1~150400.14.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python311-pluggy", rpm:"python311-pluggy~1.5.0~150400.14.10.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python311-pytest", rpm:"python311-pytest~8.3.5~150400.3.9.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python311-pytest-cov", rpm:"python311-pytest-cov~6.2.1~150400.12.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python311-pytest-mock", rpm:"python311-pytest-mock~3.14.0~150400.13.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
