...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.3682.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:3682-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.24", rpm:"go1.24~1.24.9~150000.1.42.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.24-doc", rpm:"go1.24-doc~1.24.9~150000.1.42.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.24-race", rpm:"go1.24-race~1.24.9~150000.1.42.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
