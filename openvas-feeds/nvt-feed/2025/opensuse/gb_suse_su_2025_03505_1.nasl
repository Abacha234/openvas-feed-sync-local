...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.03505.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:03505-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:03505-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-202503505-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1250995");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2025-October/042043.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'redis' package(s) announced via the SUSE-SU-2025:03505-1 advisory.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"redis", rpm:"redis~7.2.4~150600.3.18.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
