...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.4081.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:4081-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:4081-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20254081-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1252376");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1252543");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-November/023271.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'podman' package(s) announced via the SUSE-SU-2025:4081-1 advisory.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"podman", rpm:"podman~4.9.5~150500.3.56.2", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"podman-docker", rpm:"podman-docker~4.9.5~150500.3.56.2", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"podman-remote", rpm:"podman-remote~4.9.5~150500.3.56.2", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"podmansh", rpm:"podmansh~4.9.5~150500.3.56.2", rls:"openSUSELeap15.6"))) {
    report += res;
  }
