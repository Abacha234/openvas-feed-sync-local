...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.4426.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:4426-1)");
...
- CVE-2018-15853: endless recursion triggered by a crafted keymap file that induces boolean negation can lead to a
 crash (bsc#1105832).");
  ...
  script_tag(name:"affected", value:"'xkbcomp' package(s) on openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xkbcomp", rpm:"xkbcomp~1.4.1~150000.3.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xkbcomp-devel", rpm:"xkbcomp-devel~1.4.1~150000.3.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
