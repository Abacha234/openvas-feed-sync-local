...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.4336.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:4336-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.25", rpm:"go1.25~1.25.5~150000.1.23.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.25-doc", rpm:"go1.25-doc~1.25.5~150000.1.23.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.25-race", rpm:"go1.25-race~1.25.5~150000.1.23.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
