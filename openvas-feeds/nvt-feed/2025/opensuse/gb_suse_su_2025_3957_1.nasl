...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.3957.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:3957-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libtiff-devel-32bit", rpm:"libtiff-devel-32bit~4.7.1~150600.3.23.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libtiff-devel", rpm:"libtiff-devel~4.7.1~150600.3.23.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libtiff6-32bit", rpm:"libtiff6-32bit~4.7.1~150600.3.23.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libtiff6", rpm:"libtiff6~4.7.1~150600.3.23.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tiff", rpm:"tiff~4.7.1~150600.3.23.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
