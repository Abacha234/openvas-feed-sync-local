...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.119201");
  ...
  script_cve_id("CVE-2025-53067");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 9.x <= 9.4.0 Security Update (cpuoct2025) - Windows");
  ...
  # nb:
  # - No need for an "create an override" note here as the vendor actually says "9.0.0-9.4.0" on the
  #   advisory
  # - cpuoct2025 also included CVEs fixed in 8.x versions so it is currently assumed that only 9.x
  #   versions have been affected
  script_tag(name:"affected", value:"Oracle MySQL Server versions 9.x through 9.4.0.");
...
if (version_in_range(version: version, test_version: "9.0", test_version2: "9.4.0")) {
