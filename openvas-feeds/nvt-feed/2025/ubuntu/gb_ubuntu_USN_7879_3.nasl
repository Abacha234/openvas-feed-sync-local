...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7879.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-7879-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7879-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7879-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-6.14, linux-oracle-6.14' package(s) announced via the USN-7879-3 advisory.");
...
CVE-2025-38448, ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-aws-6.14, linux-oracle-6.14' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1017-aws", ver:"6.14.0-1017.17~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1017-aws-64k", ver:"6.14.0-1017.17~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1017-oracle", ver:"6.14.0-1017.17~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1017-oracle-64k", ver:"6.14.0-1017.17~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"6.14.0-1017.17~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-6.14", ver:"6.14.0-1017.17~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-64k", ver:"6.14.0-1017.17~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-64k-6.14", ver:"6.14.0-1017.17~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"6.14.0-1017.17~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-6.14", ver:"6.14.0-1017.17~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-64k", ver:"6.14.0-1017.17~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-64k-6.14", ver:"6.14.0-1017.17~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
