...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7907.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7907-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7907-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7907-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-fips, linux-fips' package(s) announced via the USN-7907-2 advisory.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.15.0-1142-fips", ver:"4.15.0-1142.154", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.15.0-2125-aws-fips", ver:"4.15.0-2125.131", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-fips", ver:"4.15.0.2125.119", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-fips-4.15", ver:"4.15.0.2125.119", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-fips", ver:"4.15.0.1142.139", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
