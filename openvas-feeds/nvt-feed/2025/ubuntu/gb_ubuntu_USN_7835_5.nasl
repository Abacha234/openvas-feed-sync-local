...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7835.5");
  ...
  script_name("Ubuntu: Security Advisory (USN-7835-5)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7835-5");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7835-5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oracle-6.8' package(s) announced via the USN-7835-5 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1038-oracle", ver:"6.8.0-1038.39~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1038-oracle-64k", ver:"6.8.0-1038.39~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"6.8.0-1038.39~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-6.8", ver:"6.8.0-1038.39~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-64k", ver:"6.8.0-1038.39~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-64k-6.8", ver:"6.8.0-1038.39~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
