...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7887.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7887-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7887-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7887-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-raspi' package(s) announced via the USN-7887-2 advisory.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1041-raspi", ver:"6.8.0-1041.45", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi", ver:"6.8.0-1041.45", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-6.8", ver:"6.8.0-1041.45", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
