...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2025-12-22 19:28:33 +0000 (Mon, 22 Dec 2025)");

  script_name("Ubuntu: Security Advisory (USN-7938-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7938-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7938-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-5.15' package(s) announced via the USN-7938-1 advisory.");
...
CVE-2024-53068, CVE-2024-53090, CVE-2024-53218, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1102-azure", ver:"5.15.0-1102.111~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"5.15.0.1102.111~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-5.15", ver:"5.15.0.1102.111~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-cvm", ver:"5.15.0.1102.111~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
