...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7835.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7835-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7835-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7835-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-realtime, linux-realtime-6.8' package(s) announced via the USN-7835-2 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.1-1036-realtime", ver:"6.8.1-1036.37~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime-6.8.1", ver:"6.8.1-1036.37~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime-hwe-22.04", ver:"6.8.1-1036.37~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.1-1036-realtime", ver:"6.8.1-1036.37", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime", ver:"6.8.1-1036.37", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime-6.8.1", ver:"6.8.1-1036.37", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
