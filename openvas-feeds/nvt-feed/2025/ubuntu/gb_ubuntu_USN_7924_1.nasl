...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7924.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7924-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7924-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7924-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libpng1.6' package(s) announced via the USN-7924-1 advisory.");
...
(CVE-2025-65018)");
  ...
  script_tag(name:"affected", value:"'libpng1.6' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04, Ubuntu 24.04, Ubuntu 25.04, Ubuntu 25.10.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpng16-16", ver:"1.6.20-2ubuntu0.1~esm2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpng16-16", ver:"1.6.34-1ubuntu0.18.04.2+esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpng16-16", ver:"1.6.37-2ubuntu0.1~esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpng16-16", ver:"1.6.37-3ubuntu0.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpng16-16t64", ver:"1.6.43-5ubuntu0.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpng16-16t64", ver:"1.6.47-1.1ubuntu0.1", rls:"UBUNTU25.04"))) {
    report += res;
  }
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpng16-16t64", ver:"1.6.50-1ubuntu0.1", rls:"UBUNTU25.10"))) {
    report += res;
  }
