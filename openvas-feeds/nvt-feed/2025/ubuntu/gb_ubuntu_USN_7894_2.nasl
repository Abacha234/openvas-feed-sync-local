...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7894.2");
  script_cve_id("CVE-2021-3712", "CVE-2022-0778", "CVE-2022-4304", "CVE-2022-4450", "CVE-2023-0215", "CVE-2023-0286", "CVE-2023-0464", "CVE-2023-0465", "CVE-2023-0466", "CVE-2023-2650", "CVE-2023-3446", "CVE-2023-3817", "CVE-2023-45236", "CVE-2023-45237", "CVE-2023-5678", "CVE-2023-6237", "CVE-2024-0727", "CVE-2024-1298", "CVE-2024-13176", "CVE-2024-2511", "CVE-2024-38796", "CVE-2024-38797", "CVE-2024-38805", "CVE-2024-41996", "CVE-2024-4741", "CVE-2024-5535", "CVE-2024-6119", "CVE-2024-9143", "CVE-2025-2295", "CVE-2025-3770", "CVE-2025-9232");
  script_tag(name:"creation_date", value:"2025-12-01 04:23:40 +0000 (Mon, 01 Dec 2025)");
  ...
  script_name("Ubuntu: Security Advisory (USN-7894-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7894-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7894-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2133157");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'edk2' package(s) announced via the USN-7894-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-7894-1 fixed vulnerabilities in EDK II. The update introduced a
...
Original advisory details:
 ...
 CVE-2025-9232)");
  ...
  script_tag(name:"affected", value:"'edk2' package(s) on Ubuntu 22.04, Ubuntu 24.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ovmf", ver:"2022.02-3ubuntu0.22.04.5", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ovmf-ia32", ver:"2022.02-3ubuntu0.22.04.5", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"qemu-efi", ver:"2022.02-3ubuntu0.22.04.5", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"qemu-efi-aarch64", ver:"2022.02-3ubuntu0.22.04.5", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"qemu-efi-arm", ver:"2022.02-3ubuntu0.22.04.5", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"efi-shell-aa64", ver:"2024.02-2ubuntu0.7", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"efi-shell-arm", ver:"2024.02-2ubuntu0.7", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"efi-shell-ia32", ver:"2024.02-2ubuntu0.7", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"efi-shell-riscv64", ver:"2024.02-2ubuntu0.7", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"efi-shell-x64", ver:"2024.02-2ubuntu0.7", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ovmf", ver:"2024.02-2ubuntu0.7", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ovmf-ia32", ver:"2024.02-2ubuntu0.7", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"qemu-efi-aarch64", ver:"2024.02-2ubuntu0.7", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"qemu-efi-arm", ver:"2024.02-2ubuntu0.7", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"qemu-efi-riscv64", ver:"2024.02-2ubuntu0.7", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
