...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7833.4");
  ...
  script_name("Ubuntu: Security Advisory (USN-7833-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7833-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7833-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gcp-6.14' package(s) announced via the USN-7833-4 advisory.");
...
CVE-2025-38191, ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-gcp-6.14' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1018-gcp", ver:"6.14.0-1018.19~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1018-gcp-64k", ver:"6.14.0-1018.19~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp", ver:"6.14.0-1018.19~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-6.14", ver:"6.14.0-1018.19~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-64k", ver:"6.14.0-1018.19~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-64k-6.14", ver:"6.14.0-1018.19~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
