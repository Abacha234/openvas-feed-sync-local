...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7909.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-7909-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7909-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7909-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-fips, linux-fips, linux-gcp-fips' package(s) announced via the USN-7909-3 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1097-aws-fips", ver:"5.15.0-1097.104+fips1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1097-gcp-fips", ver:"5.15.0-1097.106+fips1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-163-fips", ver:"5.15.0-163.173+fips1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-fips", ver:"5.15.0.1097.93", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-fips-5.15", ver:"5.15.0.1097.93", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-fips", ver:"5.15.0.163.94", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-fips-5.15", ver:"5.15.0.163.94", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-fips", ver:"5.15.0.1097.87", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-fips-5.15", ver:"5.15.0.1097.87", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
