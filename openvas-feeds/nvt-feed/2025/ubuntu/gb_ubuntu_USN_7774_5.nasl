...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7774.5");
  ...
  script_name("Ubuntu: Security Advisory (USN-7774-5)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7774-5");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7774-5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-nvidia-tegra-igx' package(s) announced via the USN-7774-5 advisory.");
...
CVE-2025-38107, CVE-2025-38160, CVE-2025-38174, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1034-nvidia-tegra-igx", ver:"5.15.0-1034.34", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1034-nvidia-tegra-igx-rt", ver:"5.15.0-1034.34", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-igx", ver:"5.15.0.1034.36", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-igx-5.15", ver:"5.15.0.1034.36", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-igx-rt", ver:"5.15.0.1034.36", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-igx-rt-5.15", ver:"5.15.0.1034.36", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
