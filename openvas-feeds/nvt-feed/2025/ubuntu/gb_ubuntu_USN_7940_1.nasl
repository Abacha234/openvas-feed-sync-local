...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7940.1");
  ...
  script_tag(name:"creation_date", value:"2025-12-19 04:14:37 +0000 (Fri, 19 Dec 2025)");
  ...
  script_name("Ubuntu: Security Advisory (USN-7940-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7940-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7940-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-fips' package(s) announced via the USN-7940-1 advisory.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1044-azure-fips", ver:"6.8.0-1044.50+fips1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fips", ver:"6.8.0-1044.50+fips1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fips-6.8", ver:"6.8.0-1044.50+fips1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
