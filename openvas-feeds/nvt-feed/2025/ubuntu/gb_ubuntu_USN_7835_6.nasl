...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7835.6");
  ...
  script_tag(name:"creation_date", value:"2025-11-13 09:36:07 +0000 (Thu, 13 Nov 2025)");
  ...
  script_name("Ubuntu: Security Advisory (USN-7835-6)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7835-6");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7835-6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-6.8' package(s) announced via the USN-7835-6 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1041-aws", ver:"6.8.0-1041.43~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1041-aws-64k", ver:"6.8.0-1041.43~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"6.8.0-1041.43~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-6.8", ver:"6.8.0-1041.43~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-64k", ver:"6.8.0-1041.43~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-64k-6.8", ver:"6.8.0-1041.43~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
