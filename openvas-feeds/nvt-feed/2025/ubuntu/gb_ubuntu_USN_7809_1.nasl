...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7809-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7809-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7809-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-nvidia' package(s) announced via the USN-7809-1 advisory.");
...
CVE-2025-38350, CVE-2025-21944, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1025-azure-nvidia", ver:"6.8.0-1025.27", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-nvidia", ver:"6.8.0-1025.27", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-nvidia-6.8", ver:"6.8.0-1025.27", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-nvidia-lts-24.04", ver:"6.8.0-1025.27", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
