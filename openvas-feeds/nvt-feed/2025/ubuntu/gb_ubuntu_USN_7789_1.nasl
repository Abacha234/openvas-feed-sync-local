...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7789.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7789-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7789-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7789-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oracle-6.14' package(s) announced via the USN-7789-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - USB sound devices,
(CVE-2025-38137, CVE-2025-38141, CVE-2025-38035, CVE-2025-38298,
CVE-2025-38042, CVE-2025-38140, CVE-2025-38138, CVE-2025-38316,
CVE-2025-38304, CVE-2025-38165, CVE-2025-38306, CVE-2025-38082,
CVE-2025-38132, CVE-2025-38498, CVE-2025-38158, CVE-2025-38154,
CVE-2025-38064, CVE-2025-38129, CVE-2025-38096, CVE-2025-38352,
CVE-2025-38303, CVE-2025-38122, CVE-2025-38048, CVE-2025-38296,
CVE-2025-38149, CVE-2025-38319, CVE-2025-38078, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1013-oracle", ver:"6.14.0-1013.13~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1013-oracle-64k", ver:"6.14.0-1013.13~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"6.14.0-1013.13~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-6.14", ver:"6.14.0-1013.13~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-64k", ver:"6.14.0-1013.13~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-64k-6.14", ver:"6.14.0-1013.13~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
