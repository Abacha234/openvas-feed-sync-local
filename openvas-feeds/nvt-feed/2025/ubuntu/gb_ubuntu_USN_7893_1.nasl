...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7893.1");
  script_cve_id("CVE-2025-46817", "CVE-2025-46818", "CVE-2025-46819", "CVE-2025-49112", "CVE-2025-49844");
  ...
  script_name("Ubuntu: Security Advisory (USN-7893-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7893-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7893-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'valkey' package(s) announced via the USN-7893-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Benny Isaacs, Nir Brakha, and Sagi Tzadik discovered that Valkey incorrectly
...
of service. (CVE-2025-49112)");
  ...
  script_tag(name:"affected", value:"'valkey' package(s) on Ubuntu 24.04, Ubuntu 25.04, Ubuntu 25.10.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"valkey-server", ver:"7.2.11+dfsg1-0ubuntu0.2", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"valkey-server", ver:"8.0.6+dfsg1-0ubuntu0.2", rls:"UBUNTU25.04"))) {
    report += res;
  }
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"valkey-server", ver:"8.1.4+dfsg1-0ubuntu0.2", rls:"UBUNTU25.10"))) {
    report += res;
  }
