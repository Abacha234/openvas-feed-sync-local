...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7775.3");
  ...
  script_tag(name:"severity_date", value:"2025-09-26 20:10:12 +0000 (Fri, 26 Sep 2025)");

  script_name("Ubuntu: Security Advisory (USN-7775-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7775-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7775-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-5.15' package(s) announced via the USN-7775-3 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - USB sound devices,
(CVE-2025-38067, CVE-2025-38371, CVE-2025-38153, CVE-2025-38160,
CVE-2024-57883, CVE-2025-38406, CVE-2025-38263, CVE-2025-38352,
CVE-2025-38147, CVE-2025-38464, CVE-2025-38362, CVE-2025-38227,
CVE-2025-38462, CVE-2025-38332, CVE-2025-38326, CVE-2025-38226,
CVE-2025-38167, CVE-2025-38085, CVE-2025-38459, CVE-2025-38345,
CVE-2025-38103, CVE-2025-38540, CVE-2025-38161, CVE-2025-38138,
CVE-2025-38159, CVE-2024-26775, CVE-2025-38249, CVE-2025-38090,
CVE-2025-38319, CVE-2025-38135, CVE-2025-38184, CVE-2025-38465,
CVE-2025-38222, CVE-2025-38445, CVE-2025-38328, CVE-2025-38111,
CVE-2025-38457, CVE-2025-38466, CVE-2025-38403, CVE-2025-38346,
CVE-2025-38441, CVE-2025-38285, CVE-2025-38444, CVE-2025-38377,
CVE-2025-38218, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1096-azure", ver:"5.15.0-1096.105~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"5.15.0.1096.105~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-5.15", ver:"5.15.0.1096.105~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-cvm", ver:"5.15.0.1096.105~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
