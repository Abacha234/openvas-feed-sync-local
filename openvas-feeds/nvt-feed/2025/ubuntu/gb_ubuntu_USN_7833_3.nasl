...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7833.3");
  ...
  script_tag(name:"creation_date", value:"2025-10-27 06:49:35 +0000 (Mon, 27 Oct 2025)");
  ...
  script_name("Ubuntu: Security Advisory (USN-7833-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7833-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7833-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-6.14' package(s) announced via the USN-7833-3 advisory.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1015-aws", ver:"6.14.0-1015.15~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1015-aws-64k", ver:"6.14.0-1015.15~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"6.14.0-1015.15~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-6.14", ver:"6.14.0-1015.15~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-64k", ver:"6.14.0-1015.15~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-64k-6.14", ver:"6.14.0-1015.15~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
