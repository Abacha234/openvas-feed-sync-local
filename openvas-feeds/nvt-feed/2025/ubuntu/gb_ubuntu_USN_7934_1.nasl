...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7934-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7934-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7934-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-azure-6.14' package(s) announced via the USN-7934-1 advisory.");
...
Jean-Claude Graf, Sandro Ruegge, Ali Hajiabadi, and Kaveh Razavi discovered
...
This update corrects flaws in the following subsystems:
 ...
 - ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-azure, linux-azure-6.14' package(s) on Ubuntu 24.04, Ubuntu 25.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1017-azure", ver:"6.14.0-1017.17~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"6.14.0-1017.17~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-6.14", ver:"6.14.0-1017.17~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1017-azure", ver:"6.14.0-1017.17", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"6.14.0-1017.17", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-6.14", ver:"6.14.0-1017.17", rls:"UBUNTU25.04"))) {
    report += res;
  }
