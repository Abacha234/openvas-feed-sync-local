...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7824.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-7824-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7824-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7824-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'redis' package(s) announced via the USN-7824-3 advisory.");
...
achieve remote code execution on the Redis server.");
  ...
  script_tag(name:"affected", value:"'redis' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"redis", ver:"5:6.0.16-1ubuntu1.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"redis-sentinel", ver:"5:6.0.16-1ubuntu1.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"redis-server", ver:"5:6.0.16-1ubuntu1.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"redis-tools", ver:"5:6.0.16-1ubuntu1.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
