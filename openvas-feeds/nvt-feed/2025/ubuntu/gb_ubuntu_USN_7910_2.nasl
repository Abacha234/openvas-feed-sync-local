...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7910.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7910-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7910-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7910-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure' package(s) announced via the USN-7910-2 advisory.");
...
CVE-2025-38347, CVE-2025-38468, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1101-azure", ver:"5.15.0-1101.110", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-5.15", ver:"5.15.0.1101.99", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-lts-22.04", ver:"5.15.0.1101.99", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
