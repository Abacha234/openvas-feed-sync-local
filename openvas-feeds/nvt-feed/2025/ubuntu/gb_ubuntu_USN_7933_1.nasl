...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7933-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7933-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7933-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-kvm' package(s) announced via the USN-7933-1 advisory.");
...
CVE-2024-53068, CVE-2025-37925, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1089-kvm", ver:"5.15.0-1089.94", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-kvm", ver:"5.15.0.1089.85", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-kvm-5.15", ver:"5.15.0.1089.85", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
