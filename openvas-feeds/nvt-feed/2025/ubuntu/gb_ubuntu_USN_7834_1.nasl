...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7834.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7834-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7834-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7834-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-azure-6.14, linux-azure-nvidia-6.14' package(s) announced via the USN-7834-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - WCD audio codecs,
 - USB sound devices,
(CVE-2025-38217, CVE-2025-38259, CVE-2025-38257, CVE-2025-38388,
CVE-2025-38258, CVE-2025-38086, CVE-2025-38416, CVE-2025-38428,
CVE-2025-38368, CVE-2025-38233, CVE-2025-38391, CVE-2025-38364,
CVE-2025-38328, CVE-2025-38417, CVE-2025-38228, CVE-2025-38413,
CVE-2025-38360, CVE-2025-38248, CVE-2025-38346, CVE-2025-38197,
CVE-2025-38179, CVE-2025-38186, CVE-2025-38356, CVE-2025-38371,
CVE-2025-38231, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-azure, linux-azure-6.14, linux-azure-nvidia-6.14' package(s) on Ubuntu 24.04, Ubuntu 25.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1007-azure-nvidia", ver:"6.14.0-1007.7", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1014-azure", ver:"6.14.0-1014.14~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"6.14.0-1014.14~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-6.14", ver:"6.14.0-1014.14~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-nvidia", ver:"6.14.0-1007.7", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-nvidia-6.14", ver:"6.14.0-1007.7", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1014-azure", ver:"6.14.0-1014.14", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"6.14.0-1014.14", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-6.14", ver:"6.14.0-1014.14", rls:"UBUNTU25.04"))) {
    report += res;
  }
