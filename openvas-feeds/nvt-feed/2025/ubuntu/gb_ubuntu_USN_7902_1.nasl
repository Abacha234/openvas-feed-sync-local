...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7902.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7902-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7902-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7902-1");
  script_xref(name:"URL", value:"https://openjdk.org/groups/vulnerability/advisories/2025-10-21");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openjdk-25-crac' package(s) announced via the USN-7902-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Jinfeng Guo discovered that the Security component of CRaC JDK 25 did not
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openjdk-25-crac-jdk", ver:"25.0.1+8-0ubuntu1~25.10", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-25-crac-jdk-headless", ver:"25.0.1+8-0ubuntu1~25.10", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-25-crac-jre", ver:"25.0.1+8-0ubuntu1~25.10", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-25-crac-jre-headless", ver:"25.0.1+8-0ubuntu1~25.10", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-25-crac-jre-zero", ver:"25.0.1+8-0ubuntu1~25.10", rls:"UBUNTU25.10"))) {
    report += res;
  }
