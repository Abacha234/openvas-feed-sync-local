...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7789.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7789-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7789-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7789-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-raspi' package(s) announced via the USN-7789-2 advisory.");
...
CVE-2025-38069, CVE-2025-38130, CVE-2025-38032, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-raspi' package(s) on Ubuntu 25.04.");
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1014-raspi", ver:"6.14.0-1014.14", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi", ver:"6.14.0-1014.14", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-6.14", ver:"6.14.0-1014.14", rls:"UBUNTU25.04"))) {
    report += res;
  }
