...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7015.7");
  ...
  script_name("Ubuntu: Security Advisory (USN-7015-7)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7015-7");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7015-7");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2125702");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python2.7' package(s) announced via the USN-7015-7 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-7015-4 fixed vulnerabilities in Python. It was discovered that the fix
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpython2.7", ver:"2.7.12-1ubuntu0~16.04.18+esm18", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python2.7", ver:"2.7.12-1ubuntu0~16.04.18+esm18", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpython2.7", ver:"2.7.17-1~18.04ubuntu1.13+esm13", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python2.7", ver:"2.7.17-1~18.04ubuntu1.13+esm13", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
