...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7927.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7927-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7927-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7927-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-urllib3' package(s) announced via the USN-7927-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Illia Volochii discovered that urllib3 did not limit the steps in a
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-urllib3", ver:"1.25.8-2ubuntu0.4+esm2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-urllib3", ver:"1.26.5-1~exp1ubuntu0.4", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-urllib3", ver:"2.0.7-1ubuntu0.3", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-urllib3", ver:"2.3.0-2ubuntu0.2", rls:"UBUNTU25.04"))) {
    report += res;
  }
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-urllib3", ver:"2.3.0-3ubuntu0.1", rls:"UBUNTU25.10"))) {
    report += res;
  }
