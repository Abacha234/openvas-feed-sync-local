...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7880.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7880-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7880-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7880-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-6.14' package(s) announced via the USN-7880-1 advisory.");
...
CVE-2025-38448, CVE-2025-38449, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1016-oem", ver:"6.14.0-1016.16", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-6.14", ver:"6.14.0-1016.16", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
