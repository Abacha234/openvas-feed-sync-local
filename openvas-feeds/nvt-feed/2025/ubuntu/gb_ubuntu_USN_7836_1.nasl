...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7836.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7836-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7836-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7836-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind9' package(s) announced via the USN-7836-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Zuyao Xu and Xiang Li discovered that Bind incorrectly handled certain
...
attack. (CVE-2025-40780)");
  ...
  script_tag(name:"affected", value:"'bind9' package(s) on Ubuntu 22.04, Ubuntu 24.04, Ubuntu 25.04, Ubuntu 25.10.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bind9", ver:"1:9.18.39-0ubuntu0.22.04.2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bind9", ver:"1:9.18.39-0ubuntu0.24.04.2", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bind9", ver:"1:9.20.11-0ubuntu0.2", rls:"UBUNTU25.04"))) {
    report += res;
  }
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bind9", ver:"1:9.20.11-1ubuntu2.1", rls:"UBUNTU25.10"))) {
    report += res;
  }
