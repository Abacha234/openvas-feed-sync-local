...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7823.1");
  script_cve_id("CVE-2024-35365", "CVE-2024-35366", "CVE-2024-35367", "CVE-2024-35368", "CVE-2024-36613", "CVE-2024-36616", "CVE-2024-36618", "CVE-2024-36619", "CVE-2024-7055");
  ...
  script_name("Ubuntu: Security Advisory (USN-7823-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7823-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7823-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ffmpeg' package(s) announced via the USN-7823-1 advisory.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ffmpeg", ver:"7:2.8.17-0ubuntu0.1+esm12", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libavcodec-dev", ver:"7:2.8.17-0ubuntu0.1+esm12", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ffmpeg", ver:"7:3.4.11-0ubuntu0.1+esm10", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libavcodec-dev", ver:"7:3.4.11-0ubuntu0.1+esm10", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ffmpeg", ver:"7:4.2.7-0ubuntu0.1+esm10", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libavcodec-dev", ver:"7:4.2.7-0ubuntu0.1+esm10", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ffmpeg", ver:"7:4.4.2-0ubuntu0.22.04.1+esm9", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libavcodec-dev", ver:"7:4.4.2-0ubuntu0.22.04.1+esm9", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ffmpeg", ver:"7:6.1.1-3ubuntu5+esm5", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libavcodec-dev", ver:"7:6.1.1-3ubuntu5+esm5", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
