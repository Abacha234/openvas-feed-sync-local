...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7691.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7691-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7691-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7691-2");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mysql-8.0' package(s) announced via the USN-7691-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-7691-1 fixed several vulnerabilities in MySQL. This update provides
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mysql-server", ver:"8.0.43-0ubuntu0.20.04.1+esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mysql-server-8.0", ver:"8.0.43-0ubuntu0.20.04.1+esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
