...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7833.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7833-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7833-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7833-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-realtime-6.14' package(s) announced via the USN-7833-2 advisory.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1014-realtime", ver:"6.14.0-1014.14~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime-6.14", ver:"6.14.0-1014.14~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime-hwe-24.04", ver:"6.14.0-1014.14~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
