...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7836.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7836-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7836-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7836-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind9' package(s) announced via the USN-7836-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-7836-1 fixed vulnerabilities in Bind. This update provides the
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bind9", ver:"1:9.18.30-0ubuntu0.20.04.2+esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
