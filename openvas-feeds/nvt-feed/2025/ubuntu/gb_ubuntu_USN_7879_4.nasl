...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7879.4");
  ...
  script_tag(name:"severity_date", value:"2025-12-02 18:14:15 +0000 (Tue, 02 Dec 2025)");

  script_name("Ubuntu: Security Advisory (USN-7879-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7879-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7879-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gcp-6.14, linux-raspi' package(s) announced via the USN-7879-4 advisory.");
...
CVE-2025-38448, ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-gcp-6.14, linux-raspi' package(s) on Ubuntu 24.04, Ubuntu 25.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1020-gcp", ver:"6.14.0-1020.21~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1020-gcp-64k", ver:"6.14.0-1020.21~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp", ver:"6.14.0-1020.21~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-6.14", ver:"6.14.0-1020.21~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-64k", ver:"6.14.0-1020.21~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-64k-6.14", ver:"6.14.0-1020.21~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1018-raspi", ver:"6.14.0-1018.18", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi", ver:"6.14.0-1018.18", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-6.14", ver:"6.14.0-1018.18", rls:"UBUNTU25.04"))) {
    report += res;
  }
