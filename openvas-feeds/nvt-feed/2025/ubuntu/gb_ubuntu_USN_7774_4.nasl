...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7774.4");
  ...
  script_name("Ubuntu: Security Advisory (USN-7774-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7774-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7774-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-kvm' package(s) announced via the USN-7774-4 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - USB sound devices,
(CVE-2025-38212, CVE-2025-38377, CVE-2025-38328, CVE-2025-38167,
CVE-2025-38119, CVE-2025-38143, CVE-2025-38513, CVE-2025-38257,
CVE-2025-38443, CVE-2025-38420, CVE-2025-38067, CVE-2025-38111,
CVE-2025-38448, CVE-2025-38107, CVE-2025-38465, CVE-2025-38237,
CVE-2025-38174, CVE-2025-38516, CVE-2025-38100, CVE-2025-38120,
CVE-2025-38219, CVE-2025-38194, CVE-2025-38085, CVE-2025-38441,
CVE-2025-38227, CVE-2024-57883, CVE-2025-38088, CVE-2025-38352,
CVE-2025-38159, CVE-2025-38410, CVE-2025-38406, CVE-2025-38204,
CVE-2025-38345, CVE-2025-38393, CVE-2025-38074, CVE-2025-38146,
CVE-2025-38160, CVE-2025-38102, CVE-2025-37963, CVE-2025-38466,
CVE-2025-38286, CVE-2025-38263, CVE-2025-38415, CVE-2025-38386,
CVE-2025-38416, CVE-2025-38375, CVE-2025-38136, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1088-kvm", ver:"5.15.0-1088.93", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-kvm", ver:"5.15.0.1088.84", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-kvm-5.15", ver:"5.15.0.1088.84", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
