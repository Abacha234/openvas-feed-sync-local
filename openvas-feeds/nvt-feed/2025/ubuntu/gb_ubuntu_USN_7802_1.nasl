...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7802.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7802-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7802-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7802-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-azure-6.8' package(s) announced via the USN-7802-1 advisory.");
...
CVE-2025-21922, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1036-azure", ver:"6.8.0-1036.42~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1036-azure-fde", ver:"6.8.0-1036.42~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"6.8.0-1036.42~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-6.8", ver:"6.8.0-1036.42~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fde", ver:"6.8.0-1036.42~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fde-6.8", ver:"6.8.0-1036.42~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1038-azure", ver:"6.8.0-1038.44", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1038-azure-fde", ver:"6.8.0-1038.44", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-6.8", ver:"6.8.0-1038.44", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fde-6.8", ver:"6.8.0-1038.44", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fde-lts-24.04", ver:"6.8.0-1038.44", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-lts-24.04", ver:"6.8.0-1038.44", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
