...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7878.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7878-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7878-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7878-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cups-filters' package(s) announced via the USN-7878-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-7878-1 fixed vulnerabilities in cups-filters, This update provides the
...
Original advisory details:
 ...
 execute arbitrary code. (CVE-2025-64524)");
  ...
  script_tag(name:"affected", value:"'cups-filters' package(s) on Ubuntu 25.04.");
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups-filters", ver:"2.0.1-0ubuntu3.25.04.1", rls:"UBUNTU25.04"))) {
    report += res;
  }
