...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7909.5");
  ...
  script_name("Ubuntu: Security Advisory (USN-7909-5)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7909-5");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7909-5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-raspi' package(s) announced via the USN-7909-5 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1091-raspi", ver:"5.15.0-1091.94", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi", ver:"5.15.0.1091.89", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-5.15", ver:"5.15.0.1091.89", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-nolpae", ver:"5.15.0.1091.89", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
