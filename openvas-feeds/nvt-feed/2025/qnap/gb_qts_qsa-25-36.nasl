...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.136102");
  ...
  script_cve_id("CVE-2025-47211", "CVE-2025-47212", "CVE-2025-47213", "CVE-2025-47214",
                "CVE-2025-48726", "CVE-2025-48727", "CVE-2025-48728", "CVE-2025-48729",
                "CVE-2025-48730", "CVE-2025-52424", "CVE-2025-52427", "CVE-2025-52428",
                "CVE-2025-52429", "CVE-2025-52432", "CVE-2025-52433", "CVE-2025-52853",
                "CVE-2025-52854", "CVE-2025-52855", "CVE-2025-52857", "CVE-2025-52858",
                "CVE-2025-52859", "CVE-2025-52860", "CVE-2025-52862", "CVE-2025-52866",
                "CVE-2025-53406", "CVE-2025-53407");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("QNAP QTS Multiple Vulnerabilities (QSA-25-36)");
  ...
  script_tag(name:"affected", value:"QNAP QTS version 5.x prior to 5.2.6.3195 build 20250715.
  ...
  script_tag(name:"solution", value:"Update to version 5.2.6.3195 build 20250715 or later.");
...
if (version =~ "^5\.") {
  if (version_is_less(version: version, test_version: "5.2.6.3195")) {
    report = report_fixed_ver(installed_version: version, installed_build: build,
                              fixed_version: "5.2.6.3195", fixed_build: "20250715");
    security_message(port: 0, data: report);
    exit(0);
  }

  if (version_is_equal(version: version, test_version: "5.2.6.3195") &&
