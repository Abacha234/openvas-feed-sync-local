...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.156074");
  script_version("2025-12-19T15:41:09+0000");
  script_tag(name:"last_modification", value:"2025-12-19 15:41:09 +0000 (Fri, 19 Dec 2025)");
  script_tag(name:"creation_date", value:"2025-12-19 05:32:18 +0000 (Fri, 19 Dec 2025)");
  script_tag(name:"cvss_base", value:"6.1");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:H/Au:N/C:N/I:P/A:C");

  script_cve_id("CVE-2025-14177", "CVE-2025-14178", "CVE-2025-14180", "CVE-2025-67899");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("PHP 8.5.x < 8.5.1 Multiple Vulnerabilities - Windows");
  ...
  - CVE-2025-67899: uriparser through 0.9.9 allows unbounded recursion and stack consumption");

  script_tag(name:"affected", value:"PHP version 8.5.x prior to 8.5.1.");

  script_tag(name:"solution", value:"Update to version 8.5.1 or later.");

  script_xref(name:"URL", value:"https://www.php.net/ChangeLog-8.php#8.5.1");
  ...
  script_xref(name:"URL", value:"https://www.openwall.com/lists/oss-security/2025/12/15/1");
...
if (version_in_range_exclusive(version: version, test_version_lo: "8.5", test_version_up: "8.5.1")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "8.5.1", install_path: location);
