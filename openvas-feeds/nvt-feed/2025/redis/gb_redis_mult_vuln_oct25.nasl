...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2025-10-06 18:47:28 +0000 (Mon, 06 Oct 2025)");
  ...
  script_name("Redis Multiple Vulnerabilities (Oct 2025)");
  ...
  - CVE-2025-49844: Lua Use-After-Free may lead to remote code execution");
