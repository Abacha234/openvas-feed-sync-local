...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.898100010099310098");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-8bd0d993db)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-8bd0d993db");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-8bd0d993db");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'cri-o1.34' package(s) announced via the FEDORA-2025-8bd0d993db advisory.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cri-o1.34", rpm:"cri-o1.34~1.34.2~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cri-o1.34-debuginfo", rpm:"cri-o1.34-debuginfo~1.34.2~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cri-o1.34-debugsource", rpm:"cri-o1.34-debugsource~1.34.2~1.fc41", rls:"FC41"))) {
    report += res;
  }
