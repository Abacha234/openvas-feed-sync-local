...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.10198991013110010224");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-ebce31df24)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-ebce31df24");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-ebce31df24");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kubernetes1.34' package(s) announced via the FEDORA-2025-ebce31df24 advisory.");
...
- Upstream fixes");
  ...
  script_tag(name:"affected", value:"'kubernetes1.34' package(s) on Fedora 41.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.34", rpm:"kubernetes1.34~1.34.2~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.34-client", rpm:"kubernetes1.34-client~1.34.2~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.34-kubeadm", rpm:"kubernetes1.34-kubeadm~1.34.2~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.34-systemd", rpm:"kubernetes1.34-systemd~1.34.2~1.fc41", rls:"FC41"))) {
    report += res;
  }
