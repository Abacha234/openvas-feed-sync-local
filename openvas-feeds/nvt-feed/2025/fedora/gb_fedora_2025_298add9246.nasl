...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.298971001009246");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-298add9246)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-298add9246");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-298add9246");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kubernetes1.33' package(s) announced via the FEDORA-2025-298add9246 advisory.");
...
- Upstream fixes");
  ...
  script_tag(name:"affected", value:"'kubernetes1.33' package(s) on Fedora 43.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.33", rpm:"kubernetes1.33~1.33.6~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.33-client", rpm:"kubernetes1.33-client~1.33.6~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.33-kubeadm", rpm:"kubernetes1.33-kubeadm~1.33.6~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.33-systemd", rpm:"kubernetes1.33-systemd~1.33.6~1.fc43", rls:"FC43"))) {
    report += res;
  }
