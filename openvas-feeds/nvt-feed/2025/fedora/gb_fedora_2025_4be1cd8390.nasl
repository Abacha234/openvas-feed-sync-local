...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.4981011991008390");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-4be1cd8390)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-4be1cd8390");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-4be1cd8390");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'yarnpkg' package(s) announced via the FEDORA-2025-4be1cd8390 advisory.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"yarnpkg", rpm:"yarnpkg~1.22.22~14.fc42", rls:"FC42"))) {
    report += res;
  }
