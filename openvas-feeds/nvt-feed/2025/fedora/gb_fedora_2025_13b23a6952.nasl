...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.139823976952");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-13b23a6952)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-13b23a6952");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-13b23a6952");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'tkimg' package(s) announced via the FEDORA-2025-13b23a6952 advisory.");
  ...
  script_tag(name:"affected", value:"'tkimg' package(s) on Fedora 43.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tkimg", rpm:"tkimg~2.1.0~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tkimg-debuginfo", rpm:"tkimg-debuginfo~2.1.0~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tkimg-debugsource", rpm:"tkimg-debugsource~2.1.0~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tkimg-devel", rpm:"tkimg-devel~2.1.0~1.fc43", rls:"FC43"))) {
    report += res;
  }
