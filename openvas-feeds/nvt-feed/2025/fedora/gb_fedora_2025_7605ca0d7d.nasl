...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.7605999701007100");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-7605ca0d7d)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-7605ca0d7d");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-7605ca0d7d");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'cef' package(s) announced via the FEDORA-2025-7605ca0d7d advisory.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cef", rpm:"cef~143.0.10^chromium143.0.7499.146~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cef-debuginfo", rpm:"cef-debuginfo~143.0.10^chromium143.0.7499.146~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cef-devel", rpm:"cef-devel~143.0.10^chromium143.0.7499.146~1.fc42", rls:"FC42"))) {
    report += res;
  }
