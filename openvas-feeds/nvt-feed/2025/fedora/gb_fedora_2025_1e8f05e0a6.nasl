...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.11018102051010976");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-1e8f05e0a6)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-1e8f05e0a6");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-1e8f05e0a6");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2396308");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cef' package(s) announced via the FEDORA-2025-1e8f05e0a6 advisory.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cef", rpm:"cef~140.1.15^chromium140.0.7339.207~3.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cef-debuginfo", rpm:"cef-debuginfo~140.1.15^chromium140.0.7339.207~3.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cef-devel", rpm:"cef-devel~140.1.15^chromium140.0.7339.207~3.fc43", rls:"FC43"))) {
    report += res;
  }
