...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.941029989981981");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-94f9b9b1b1)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-94f9b9b1b1");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-94f9b9b1b1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'docker-buildkit' package(s) announced via the FEDORA-2025-94f9b9b1b1 advisory.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"docker-buildkit", rpm:"docker-buildkit~0.26.3~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"docker-buildkit-debuginfo", rpm:"docker-buildkit-debuginfo~0.26.3~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"docker-buildkit-debugsource", rpm:"docker-buildkit-debugsource~0.26.3~1.fc43", rls:"FC43"))) {
    report += res;
  }
