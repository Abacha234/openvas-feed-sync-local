...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.10199990011006995");
  ...
  script_tag(name:"severity_date", value:"2025-10-06 18:26:51 +0000 (Mon, 06 Oct 2025)");

  script_name("Fedora: Security Advisory (FEDORA-2025-ecc001d6c5)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-ecc001d6c5");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-ecc001d6c5");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'tcpreplay' package(s) announced via the FEDORA-2025-ecc001d6c5 advisory.");
...
[link moved to references]");
  ...
  script_tag(name:"affected", value:"'tcpreplay' package(s) on Fedora 43.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tcpreplay", rpm:"tcpreplay~4.5.2~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tcpreplay-debuginfo", rpm:"tcpreplay-debuginfo~4.5.2~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tcpreplay-debugsource", rpm:"tcpreplay-debugsource~4.5.2~1.fc43", rls:"FC43"))) {
    report += res;
  }
