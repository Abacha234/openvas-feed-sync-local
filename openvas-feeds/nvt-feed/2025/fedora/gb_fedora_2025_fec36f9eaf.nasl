...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.1021019936102910197102");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-fec36f9eaf)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-fec36f9eaf");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-fec36f9eaf");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2423518");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2423530");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'roundcubemail' package(s) announced via the FEDORA-2025-fec36f9eaf advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"## Release 1.6.12
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"roundcubemail", rpm:"roundcubemail~1.6.12~1.fc42", rls:"FC42"))) {
    report += res;
  }
