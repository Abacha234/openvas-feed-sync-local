...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.98110071007102810098");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-b1d7d7f8db)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-b1d7d7f8db");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-b1d7d7f8db");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'docker-buildx' package(s) announced via the FEDORA-2025-b1d7d7f8db advisory.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"docker-buildx", rpm:"docker-buildx~0.30.1~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"docker-buildx-debuginfo", rpm:"docker-buildx-debuginfo~0.30.1~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"docker-buildx-debugsource", rpm:"docker-buildx-debugsource~0.30.1~1.fc43", rls:"FC43"))) {
    report += res;
  }
