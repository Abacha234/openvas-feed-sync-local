...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.9799100310111344");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-acd3e11344)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-acd3e11344");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-acd3e11344");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wordpress' package(s) announced via the FEDORA-2025-acd3e11344 advisory.");
...
* A cross-site scripting (XSS) vulnerability requiring an authenticated user role that affects the nav menus. Reported by Phill Savage.");
  ...
  script_tag(name:"affected", value:"'wordpress' package(s) on Fedora 41.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~6.8.3~1.fc41", rls:"FC41"))) {
    report += res;
  }
