...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.523798210210257");
  script_cve_id("CVE-2025-4437", "CVE-2025-47910");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-5237b2ff57)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-5237b2ff57");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-5237b2ff57");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'cri-o1.33' package(s) announced via the FEDORA-2025-5237b2ff57 advisory.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cri-o1.33", rpm:"cri-o1.33~1.33.5~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cri-o1.33-debuginfo", rpm:"cri-o1.33-debuginfo~1.33.5~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cri-o1.33-debugsource", rpm:"cri-o1.33-debugsource~1.33.5~1.fc43", rls:"FC43"))) {
    report += res;
  }
