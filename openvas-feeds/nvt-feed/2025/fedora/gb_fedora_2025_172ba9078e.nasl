...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.17298979078101");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-172ba9078e)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-172ba9078e");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-172ba9078e");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'cri-o1.33' package(s) announced via the FEDORA-2025-172ba9078e advisory.");
...
- Upstream fixes");
  ...
  script_tag(name:"affected", value:"'cri-o1.33' package(s) on Fedora 42.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cri-o1.33", rpm:"cri-o1.33~1.33.5~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cri-o1.33-debuginfo", rpm:"cri-o1.33-debuginfo~1.33.5~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cri-o1.33-debugsource", rpm:"cri-o1.33-debugsource~1.33.5~1.fc42", rls:"FC42"))) {
    report += res;
  }
