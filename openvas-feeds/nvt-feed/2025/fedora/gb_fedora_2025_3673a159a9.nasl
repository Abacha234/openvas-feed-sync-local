...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.367397159979");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-3673a159a9)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-3673a159a9");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3673a159a9");
  ...
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2404261");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-socketio' package(s) announced via the FEDORA-2025-3673a159a9 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"**Release 5.14.2** - 2025-10-15
...
- Add SPDX license identifier");
  ...
  script_tag(name:"affected", value:"'python-socketio' package(s) on Fedora 43.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-socketio", rpm:"python-socketio~5.14.2~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-socketio+asyncio_client", rpm:"python3-socketio+asyncio_client~5.14.2~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-socketio+client", rpm:"python3-socketio+client~5.14.2~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-socketio", rpm:"python3-socketio~5.14.2~1.fc43", rls:"FC43"))) {
    report += res;
  }
