...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.510299310236099102");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-5fc3f360cf)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-5fc3f360cf");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-5fc3f360cf");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'forgejo' package(s) announced via the FEDORA-2025-5fc3f360cf advisory.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"forgejo", rpm:"forgejo~12.0.3~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"forgejo-debuginfo", rpm:"forgejo-debuginfo~12.0.3~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"forgejo-debugsource", rpm:"forgejo-debugsource~12.0.3~1.fc43", rls:"FC43"))) {
    report += res;
  }
