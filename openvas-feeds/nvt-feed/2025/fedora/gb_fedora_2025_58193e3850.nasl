...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.581931013850");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-58193e3850)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-58193e3850");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-58193e3850");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cef' package(s) announced via the FEDORA-2025-58193e3850 advisory.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cef", rpm:"cef~142.0.14^chromium142.0.7444.162~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cef-debuginfo", rpm:"cef-debuginfo~142.0.14^chromium142.0.7444.162~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cef-devel", rpm:"cef-devel~142.0.14^chromium142.0.7444.162~1.fc42", rls:"FC42"))) {
    report += res;
  }
