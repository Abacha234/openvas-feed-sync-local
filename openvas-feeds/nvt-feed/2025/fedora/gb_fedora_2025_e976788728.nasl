...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.101976788728");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-e976788728)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-e976788728");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e976788728");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'cri-o1.32' package(s) announced via the FEDORA-2025-e976788728 advisory.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cri-o1.32", rpm:"cri-o1.32~1.32.9~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cri-o1.32-debuginfo", rpm:"cri-o1.32-debuginfo~1.32.9~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cri-o1.32-debugsource", rpm:"cri-o1.32-debugsource~1.32.9~1.fc41", rls:"FC41"))) {
    report += res;
  }
