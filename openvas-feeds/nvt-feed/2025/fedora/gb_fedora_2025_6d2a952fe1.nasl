...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.61002979521021011");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-6d2a952fe1)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-6d2a952fe1");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-6d2a952fe1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'cri-o1.34' package(s) announced via the FEDORA-2025-6d2a952fe1 advisory.");
...
- Upstream fixes");
  ...
  script_tag(name:"affected", value:"'cri-o1.34' package(s) on Fedora 42.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cri-o1.34", rpm:"cri-o1.34~1.34.1~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cri-o1.34-debuginfo", rpm:"cri-o1.34-debuginfo~1.34.1~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cri-o1.34-debugsource", rpm:"cri-o1.34-debugsource~1.34.1~1.fc42", rls:"FC42"))) {
    report += res;
  }
