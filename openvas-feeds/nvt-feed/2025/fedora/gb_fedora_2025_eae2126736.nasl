...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.101971012126736");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-eae2126736)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-eae2126736");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-eae2126736");
  ...
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2365000");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2365053");
  ...
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2402988");
  ...
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2403525");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2403530");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rubygem-rack' package(s) announced via the FEDORA-2025-eae2126736 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Update to Rack 2.2.21");

  script_tag(name:"affected", value:"'rubygem-rack' package(s) on Fedora 42.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rubygem-rack", rpm:"rubygem-rack~2.2.21~9.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rubygem-rack-doc", rpm:"rubygem-rack-doc~2.2.21~9.fc42", rls:"FC42"))) {
    report += res;
  }
