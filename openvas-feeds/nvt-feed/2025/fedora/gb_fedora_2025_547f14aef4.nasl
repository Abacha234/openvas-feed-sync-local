...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.54710214971011024");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-547f14aef4)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-547f14aef4");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-547f14aef4");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kubernetes1.32' package(s) announced via the FEDORA-2025-547f14aef4 advisory.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.32", rpm:"kubernetes1.32~1.32.10~2.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.32-client", rpm:"kubernetes1.32-client~1.32.10~2.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.32-kubeadm", rpm:"kubernetes1.32-kubeadm~1.32.10~2.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.32-systemd", rpm:"kubernetes1.32-systemd~1.32.10~2.fc41", rls:"FC41"))) {
    report += res;
  }
