...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.8101719798102396");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-8e71abf396)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-8e71abf396");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-8e71abf396");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wordpress' package(s) announced via the FEDORA-2025-8e71abf396 advisory.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~6.8.3~1.fc43", rls:"FC43"))) {
    report += res;
  }
