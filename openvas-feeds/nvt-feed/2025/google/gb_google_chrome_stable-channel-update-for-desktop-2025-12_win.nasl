...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836880");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop-2025-12) - Windows");
