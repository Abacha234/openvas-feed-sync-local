...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.03540.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:03540-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:03540-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-202503540-1.html");
  ...
  script_xref(name:"URL", value:"https://github.com/moby/moby/pull/48517");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2025-October/042077.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'docker-stable' package(s) announced via the SUSE-SU-2025:03540-1 advisory.");
...
- Backport <[link moved to references]>. bsc#1247362
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"docker-stable", rpm:"docker-stable~24.0.9_ce~1.20.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"docker-stable-bash-completion", rpm:"docker-stable-bash-completion~24.0.9_ce~1.20.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
