...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.4396.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:4396-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:4396-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20254396-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1254551");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-December/023541.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaFirefox' package(s) announced via the SUSE-SU-2025:4396-1 advisory.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox", rpm:"MozillaFirefox~140.6.0~112.292.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-devel", rpm:"MozillaFirefox-devel~140.6.0~112.292.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations-common", rpm:"MozillaFirefox-translations-common~140.6.0~112.292.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
