...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.4073.2");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:4073-2)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:4073-2");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20254073-2.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-November/023325.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'runc' package(s) announced via the SUSE-SU-2025:4073-2 advisory.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"runc", rpm:"runc~1.3.3~150000.85.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"runc", rpm:"runc~1.3.3~150000.85.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"runc", rpm:"runc~1.3.3~150000.85.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
