...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.3699.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:3699-1)");
...
To re-enable those algorithms, you can use allow options in krb5.conf:
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"krb5", rpm:"krb5~1.20.1~150600.11.14.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"krb5-32bit", rpm:"krb5-32bit~1.20.1~150600.11.14.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"krb5-client", rpm:"krb5-client~1.20.1~150600.11.14.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"krb5-devel", rpm:"krb5-devel~1.20.1~150600.11.14.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"krb5-plugin-preauth-otp", rpm:"krb5-plugin-preauth-otp~1.20.1~150600.11.14.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"krb5-plugin-preauth-pkinit", rpm:"krb5-plugin-preauth-pkinit~1.20.1~150600.11.14.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
