...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.3722.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:3722-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:3722-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20253722-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1244663");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-October/022970.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'protobuf' package(s) announced via the SUSE-SU-2025:3722-1 advisory.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libprotobuf20", rpm:"libprotobuf20~3.9.2~150200.4.27.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
