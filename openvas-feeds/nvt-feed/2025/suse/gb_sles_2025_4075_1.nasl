...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.4075.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:4075-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:4075-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20254075-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1252543");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1253096");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-November/023263.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'buildah' package(s) announced via the SUSE-SU-2025:4075-1 advisory.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"buildah", rpm:"buildah~1.35.5~150300.8.46.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
