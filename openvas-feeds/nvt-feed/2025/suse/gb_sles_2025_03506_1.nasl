...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.03506.1");
  script_cve_id("CVE-2025-46817", "CVE-2025-46818", "CVE-2025-46819", "CVE-2025-49844");
  script_tag(name:"creation_date", value:"2025-10-10 04:12:39 +0000 (Fri, 10 Oct 2025)");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:03506-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:03506-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-202503506-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1250995");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2025-October/042042.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'redis' package(s) announced via the SUSE-SU-2025:03506-1 advisory.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"redis", rpm:"redis~6.2.6~150400.3.40.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"redis", rpm:"redis~6.2.6~150400.3.40.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
