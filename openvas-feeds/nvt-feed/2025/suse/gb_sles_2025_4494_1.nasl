...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.4494.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:4494-1)");
...
- CVE-2025-64505: Fixed heap buffer over-read in `png_do_quantize` via malformed palette index (bsc#1254157)");
  ...
  script_tag(name:"affected", value:"'libpng16' package(s) on SUSE Linux Enterprise Server 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libpng16-16", rpm:"libpng16-16~1.6.40~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libpng16-16-32bit", rpm:"libpng16-16-32bit~1.6.40~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libpng16-compat-devel", rpm:"libpng16-compat-devel~1.6.40~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libpng16-devel", rpm:"libpng16-devel~1.6.40~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
