...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.03449.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:03449-1)");
...
- Update to version 1.18.2:
 ...
 + Cairo requires a C11 toolchain when building.");
  ...
  script_tag(name:"affected", value:"'cairo' package(s) on SUSE Linux Enterprise Server 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cairo-devel", rpm:"cairo-devel~1.18.4~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libcairo-gobject2", rpm:"libcairo-gobject2~1.18.4~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libcairo-script-interpreter2", rpm:"libcairo-script-interpreter2~1.18.4~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libcairo2", rpm:"libcairo2~1.18.4~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
