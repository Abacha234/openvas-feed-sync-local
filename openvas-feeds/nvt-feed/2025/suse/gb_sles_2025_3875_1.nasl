...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.3875.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:3875-1)");
 ...
 - CVE-2025-10911: last fix caused a regression, patch was temporary disabled (bsc#1250553)");
  ...
  script_tag(name:"affected", value:"'libxslt' package(s) on SUSE Linux Enterprise Server 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libxslt-devel", rpm:"libxslt-devel~1.1.34~150400.3.13.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libxslt-tools", rpm:"libxslt-tools~1.1.34~150400.3.13.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libxslt1", rpm:"libxslt1~1.1.34~150400.3.13.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
