...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.4388.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:4388-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"postgresql16", rpm:"postgresql16~16.11~150600.16.25.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
