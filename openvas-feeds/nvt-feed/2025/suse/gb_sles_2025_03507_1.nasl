...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.03507.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:03507-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:03507-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-202503507-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1250995");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2025-October/042041.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'redis' package(s) announced via the SUSE-SU-2025:03507-1 advisory.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"redis", rpm:"redis~6.0.14~150200.6.43.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
