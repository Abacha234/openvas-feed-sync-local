...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.4187.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:4187-1)");
...
- Security issues fixed:
 ...
 of privileges (bsc#1246860)");
  ...
  script_tag(name:"affected", value:"'nvidia-container-toolkit' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server 15-SP5, SUSE Linux Enterprise Server for SAP Applications 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP5.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nvidia-container-toolkit", rpm:"nvidia-container-toolkit~1.18.0~150200.5.17.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nvidia-container-toolkit", rpm:"nvidia-container-toolkit~1.18.0~150200.5.17.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nvidia-container-toolkit", rpm:"nvidia-container-toolkit~1.18.0~150200.5.17.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
