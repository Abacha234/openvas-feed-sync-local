...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.4080.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:4080-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:4080-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20254080-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-November/023272.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'podman' package(s) announced via the SUSE-SU-2025:4080-1 advisory.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"podman", rpm:"podman~4.9.5~150300.9.63.2", rls:"SLES15.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"podman-remote", rpm:"podman-remote~4.9.5~150300.9.63.2", rls:"SLES15.0SP3"))) {
    report += res;
  }
