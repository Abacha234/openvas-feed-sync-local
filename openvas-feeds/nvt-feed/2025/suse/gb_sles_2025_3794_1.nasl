...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.3794.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:3794-1)");
...
This update also ships chrony-pool-empty to SLE Micro 5.x (jsc#SMO-587)");
  ...
  script_tag(name:"affected", value:"'chrony' package(s) on SUSE Linux Enterprise Server 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chrony", rpm:"chrony~4.1~150400.21.8.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chrony-pool-empty", rpm:"chrony-pool-empty~4.1~150400.21.8.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chrony-pool-suse", rpm:"chrony-pool-suse~4.1~150400.21.8.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
