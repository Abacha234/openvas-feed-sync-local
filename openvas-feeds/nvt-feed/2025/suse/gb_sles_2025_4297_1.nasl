...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.4297.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:4297-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libpython3_11-1_0", rpm:"libpython3_11-1_0~3.11.14~150600.3.38.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python311-base", rpm:"python311-base~3.11.14~150600.3.38.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
