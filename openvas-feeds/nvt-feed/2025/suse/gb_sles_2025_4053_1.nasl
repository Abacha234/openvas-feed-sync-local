...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.4053.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:4053-1)");
 ...
 * Bug Fixes. See Resolved section in README.md");
  ...
  script_tag(name:"affected", value:"'qatengine, qatlib' package(s) on SUSE Linux Enterprise Server 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libqat4", rpm:"libqat4~24.09.0~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libusdm0", rpm:"libusdm0~24.09.0~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qatengine", rpm:"qatengine~1.7.0~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qatlib", rpm:"qatlib~24.09.0~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qatlib-devel", rpm:"qatlib-devel~24.09.0~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
