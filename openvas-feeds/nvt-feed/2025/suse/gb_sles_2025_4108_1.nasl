...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.4108.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:4108-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:4108-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20254108-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1252379");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1252380");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-November/023289.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind' package(s) announced via the SUSE-SU-2025:4108-1 advisory.");
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"bind", rpm:"bind~9.16.50~150500.8.32.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"bind-doc", rpm:"bind-doc~9.16.50~150500.8.32.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"bind-utils", rpm:"bind-utils~9.16.50~150500.8.32.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-bind", rpm:"python3-bind~9.16.50~150500.8.32.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
