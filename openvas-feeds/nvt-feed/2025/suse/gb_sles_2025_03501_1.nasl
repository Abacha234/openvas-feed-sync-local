...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.03501.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:03501-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:03501-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-202503501-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1250995");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2025-October/042045.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'redis7' package(s) announced via the SUSE-SU-2025:03501-1 advisory.");
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"redis7", rpm:"redis7~7.0.8~150500.3.24.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
