...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.03424.1");
  script_cve_id("CVE-2025-23277", "CVE-2025-23278", "CVE-2025-23279", "CVE-2025-23283", "CVE-2025-23286");
  script_tag(name:"creation_date", value:"2025-10-01 04:11:41 +0000 (Wed, 01 Oct 2025)");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:03424-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:03424-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-202503424-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2025-September/041970.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nvidia-open-driver-G06-signed' package(s) announced via the SUSE-SU-2025:03424-1 advisory.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nv-prefer-signed-open-driver", rpm:"nv-prefer-signed-open-driver~580.82.07~150400.98.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nvidia-open-driver-G06-signed-64kb-devel", rpm:"nvidia-open-driver-G06-signed-64kb-devel~580.82.07~150400.98.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nvidia-open-driver-G06-signed-cuda-64kb-devel", rpm:"nvidia-open-driver-G06-signed-cuda-64kb-devel~580.82.07~150400.98.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nvidia-open-driver-G06-signed-cuda-default-devel", rpm:"nvidia-open-driver-G06-signed-cuda-default-devel~580.82.07~150400.98.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nvidia-open-driver-G06-signed-cuda-kmp-64kb", rpm:"nvidia-open-driver-G06-signed-cuda-kmp-64kb~580.82.07_k5.14.21_150400.24.173~150400.98.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nvidia-open-driver-G06-signed-cuda-kmp-default", rpm:"nvidia-open-driver-G06-signed-cuda-kmp-default~580.82.07_k5.14.21_150400.24.173~150400.98.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nvidia-open-driver-G06-signed-default-devel", rpm:"nvidia-open-driver-G06-signed-default-devel~580.82.07~150400.98.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nvidia-open-driver-G06-signed-kmp-64kb", rpm:"nvidia-open-driver-G06-signed-kmp-64kb~580.82.07_k5.14.21_150400.24.173~150400.98.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nvidia-open-driver-G06-signed-kmp-default", rpm:"nvidia-open-driver-G06-signed-kmp-default~580.82.07_k5.14.21_150400.24.173~150400.98.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
