...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2514");
  ...
  script_name("Huawei EulerOS: Security Advisory for avahi (EulerOS-SA-2025-2514)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2514");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2514");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'avahi' package(s) announced via the EulerOS-SA-2025-2514 advisory.");
...
if(release == "EULEROS-2.0SP13") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"avahi-libs", rpm:"avahi-libs~0.8~18.h3.eulerosv2r13", rls:"EULEROS-2.0SP13"))) {
    report += res;
  }
