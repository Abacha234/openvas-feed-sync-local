...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2203");
  script_cve_id("CVE-2025-49794", "CVE-2025-49796", "CVE-2025-6170");
  ...
  script_name("Huawei EulerOS: Security Advisory for libxml2 (EulerOS-SA-2025-2203)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2203");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2203");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libxml2' package(s) announced via the EulerOS-SA-2025-2203 advisory.");
...
if(release == "EULEROS-2.0SP11-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libxml2", rpm:"libxml2~2.9.12~5.h37.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-libxml2", rpm:"python3-libxml2~2.9.12~5.h37.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }
