...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2477");
  ...
  script_name("Huawei EulerOS: Security Advisory for cups (EulerOS-SA-2025-2477)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2477");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2477");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'cups' package(s) announced via the EulerOS-SA-2025-2477 advisory.");
...
if(release == "EULEROS-2.0SP11") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cups-libs", rpm:"cups-libs~2.4.0~3.h8.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }
