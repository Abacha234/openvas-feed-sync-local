...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2449");
  script_cve_id("CVE-2025-8534", "CVE-2025-8851");
  ...
  script_tag(name:"severity_date", value:"2025-08-11 14:15:27 +0000 (Mon, 11 Aug 2025)");

  script_name("Huawei EulerOS: Security Advisory for libtiff (EulerOS-SA-2025-2449)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2449");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2449");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libtiff' package(s) announced via the EulerOS-SA-2025-2449 advisory.");
...
if(release == "EULEROS-2.0SP13") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libtiff", rpm:"libtiff~4.3.0~36.h9.eulerosv2r13", rls:"EULEROS-2.0SP13"))) {
    report += res;
  }
