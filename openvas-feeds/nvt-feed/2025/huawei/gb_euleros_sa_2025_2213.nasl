...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2213");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-urllib3 (EulerOS-SA-2025-2213)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2213");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2213");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-urllib3' package(s) announced via the EulerOS-SA-2025-2213 advisory.");
...
if(release == "EULEROS-2.0SP11-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-urllib3", rpm:"python3-urllib3~1.26.7~2.h9.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }
