...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2521");
  ...
  script_name("Huawei EulerOS: Security Advisory for golang (EulerOS-SA-2025-2521)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2521");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2521");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'golang' package(s) announced via the EulerOS-SA-2025-2521 advisory.");
...
if(release == "EULEROS-2.0SP13") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang", rpm:"golang~1.21.4~8.h115.eulerosv2r13", rls:"EULEROS-2.0SP13"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"golang-devel", rpm:"golang-devel~1.21.4~8.h115.eulerosv2r13", rls:"EULEROS-2.0SP13"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"golang-help", rpm:"golang-help~1.21.4~8.h115.eulerosv2r13", rls:"EULEROS-2.0SP13"))) {
    report += res;
  }
