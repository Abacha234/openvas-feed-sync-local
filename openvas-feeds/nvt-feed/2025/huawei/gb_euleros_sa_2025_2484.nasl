...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2484");
  ...
  script_name("Huawei EulerOS: Security Advisory for libssh (EulerOS-SA-2025-2484)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2484");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2484");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libssh' package(s) announced via the EulerOS-SA-2025-2484 advisory.");
...
if(release == "EULEROS-2.0SP11") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libssh", rpm:"libssh~0.9.6~2.h17.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }
