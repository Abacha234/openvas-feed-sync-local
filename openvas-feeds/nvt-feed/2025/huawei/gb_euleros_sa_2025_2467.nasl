...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2467");
  ...
  script_name("Huawei EulerOS: Security Advisory for mod_http2 (EulerOS-SA-2025-2467)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2467");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2467");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'mod_http2' package(s) announced via the EulerOS-SA-2025-2467 advisory.");
...
Configurations affected are a reverse proxy is configured for an HTTP/2 backend, with ProxyPreserveHost set to 'on'.(CVE-2025-49630)");
  ...
  script_tag(name:"affected", value:"'mod_http2' package(s) on Huawei EulerOS V2.0SP11(x86_64).");
...
if(release == "EULEROS-2.0SP11-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mod_http2", rpm:"mod_http2~1.15.25~1.h2.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }
