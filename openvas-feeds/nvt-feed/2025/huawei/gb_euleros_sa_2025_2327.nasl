...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2327");
  ...
  script_name("Huawei EulerOS: Security Advisory for golang (EulerOS-SA-2025-2327)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2327");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2327");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'golang' package(s) announced via the EulerOS-SA-2025-2327 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Cancelling a query (e.g. by cancelling the context passed to one of the query methods) during a call to the Scan method of the returned Rows can result in unexpected results if other queries are being made in parallel. This can result in a race condition that may overwrite the expected results with those of another query, causing the call to Scan to return either unexpected results from the other query or an error.(CVE-2025-47907)
...
if(release == "EULEROS-2.0SP12-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang", rpm:"golang~1.17.3~12.h29.eulerosv2r12", rls:"EULEROS-2.0SP12-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"golang-devel", rpm:"golang-devel~1.17.3~12.h29.eulerosv2r12", rls:"EULEROS-2.0SP12-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"golang-help", rpm:"golang-help~1.17.3~12.h29.eulerosv2r12", rls:"EULEROS-2.0SP12-x86_64"))) {
    report += res;
  }
