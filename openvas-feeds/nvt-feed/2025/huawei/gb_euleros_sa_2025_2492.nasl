...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2492");
  ...
  script_name("Huawei EulerOS: Security Advisory for aide (EulerOS-SA-2025-2492)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2492");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2492");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'aide' package(s) announced via the EulerOS-SA-2025-2492 advisory.");
...
AIDE is an advanced intrusion detection environment. From versions 0.13 to 0.19.1, there is a null pointer dereference vulnerability in AIDE. An attacker can crash the program during report printing or database listing after setting extended file attributes with an empty attribute value or with a key containing a comma. A local user might exploit this to cause a local denial of service. This issue has been patched in version 0.19.2. A workaround involves removing xattrs group from rules matching files on affected file systems.(CVE-2025-54409)");
  ...
  script_tag(name:"affected", value:"'aide' package(s) on Huawei EulerOS V2.0SP13(x86_64).");
...
if(release == "EULEROS-2.0SP13-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"aide", rpm:"aide~0.17.4~3.h4.eulerosv2r13", rls:"EULEROS-2.0SP13-x86_64"))) {
    report += res;
  }
