...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2508");
  ...
  script_name("Huawei EulerOS: Security Advisory for python3 (EulerOS-SA-2025-2508)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2508");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2508");
  script_xref(name:"URL", value:"https://gist.github.com/sethmlarson/1716ac5b82b73dbcbf23ad2eff8b33e1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python3' package(s) announced via the EulerOS-SA-2025-2508 advisory.");
...
if(release == "EULEROS-2.0SP13-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3", rpm:"python3~3.9.9~28.h17.eulerosv2r13", rls:"EULEROS-2.0SP13-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-fgo", rpm:"python3-fgo~3.9.9~28.h17.eulerosv2r13", rls:"EULEROS-2.0SP13-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-unversioned-command", rpm:"python3-unversioned-command~3.9.9~28.h17.eulerosv2r13", rls:"EULEROS-2.0SP13-x86_64"))) {
    report += res;
  }
