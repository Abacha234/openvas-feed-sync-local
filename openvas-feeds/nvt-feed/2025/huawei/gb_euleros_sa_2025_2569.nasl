...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2569");
  ...
  script_name("Huawei EulerOS: Security Advisory for binutils (EulerOS-SA-2025-2569)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2569");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2569");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'binutils' package(s) announced via the EulerOS-SA-2025-2569 advisory.");
...
if(release == "EULEROSVIRT-2.13.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"binutils", rpm:"binutils~2.37~24.h6.eulerosv2r13", rls:"EULEROSVIRT-2.13.0"))) {
    report += res;
  }
