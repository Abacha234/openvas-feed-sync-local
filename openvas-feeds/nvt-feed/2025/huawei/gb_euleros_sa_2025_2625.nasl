...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2625");
  script_cve_id("CVE-2025-9165", "CVE-2025-9900");
  ...
  script_name("Huawei EulerOS: Security Advisory for libtiff (EulerOS-SA-2025-2625)");
...
By providing an abnormally large image height value in the file's metadata, an attacker can trick the library into writing attacker-controlled color data to an arbitrary memory location. This memory corruption can be exploited to cause a denial of service (application crash) or to achieve arbitrary code execution with the permissions of the user.(CVE-2025-9900)");
  ...
  script_tag(name:"affected", value:"'libtiff' package(s) on Huawei EulerOS Virtualization release 2.13.1.");
...
if(release == "EULEROSVIRT-2.13.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libtiff", rpm:"libtiff~4.3.0~36.h12.eulerosv2r13", rls:"EULEROSVIRT-2.13.1"))) {
    report += res;
  }
