...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2377");
  ...
  script_name("Huawei EulerOS: Security Advisory for aide (EulerOS-SA-2025-2377)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2377");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2377");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'aide' package(s) announced via the EulerOS-SA-2025-2377 advisory.");
...
if(release == "EULEROS-2.0SP10-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"aide", rpm:"aide~0.16.2~1.h9.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }
