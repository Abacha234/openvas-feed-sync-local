...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2536");
  ...
  script_name("Huawei EulerOS: Security Advisory for EDK2 (EulerOS-SA-2025-2536)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2536");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2536");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'EDK2' package(s) announced via the EulerOS-SA-2025-2536 advisory.");
...
EDK2 contains a vulnerability in the HashPeImageByType(). A user may cause a read out of bounds when a corrupted data pointer and length are sent via an adjecent network. A successful exploit of this vulnerability may lead to a loss of Integrity and/or Availability.(CVE-2024-38797)");
  ...
  script_tag(name:"affected", value:"'EDK2' package(s) on Huawei EulerOS Virtualization release 2.13.1.");
...
if(release == "EULEROSVIRT-2.13.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"edk2-aarch64", rpm:"edk2-aarch64~202011.oe2203sp3~2.13.0.6.70", rls:"EULEROSVIRT-2.13.1"))) {
    report += res;
  }
