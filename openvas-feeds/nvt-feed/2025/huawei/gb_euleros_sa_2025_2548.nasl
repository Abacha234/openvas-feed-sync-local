...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2548");
  ...
  script_name("Huawei EulerOS: Security Advisory for libarchive (EulerOS-SA-2025-2548)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2548");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2548");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libarchive' package(s) announced via the EulerOS-SA-2025-2548 advisory.");
...
if(release == "EULEROSVIRT-2.13.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libarchive", rpm:"libarchive~3.5.2~6.h6.eulerosv2r13", rls:"EULEROSVIRT-2.13.1"))) {
    report += res;
  }
