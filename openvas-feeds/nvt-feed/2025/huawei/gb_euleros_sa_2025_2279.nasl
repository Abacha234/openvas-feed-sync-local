...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2279");
  ...
  script_name("Huawei EulerOS: Security Advisory for sudo (EulerOS-SA-2025-2279)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2279");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2279");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'sudo' package(s) announced via the EulerOS-SA-2025-2279 advisory.");
  ...
  script_tag(name:"affected", value:"'sudo' package(s) on Huawei EulerOS V2.0SP13(x86_64).");
...
if(release == "EULEROS-2.0SP13-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sudo", rpm:"sudo~1.9.8p2~15.h3.eulerosv2r13", rls:"EULEROS-2.0SP13-x86_64"))) {
    report += res;
  }
