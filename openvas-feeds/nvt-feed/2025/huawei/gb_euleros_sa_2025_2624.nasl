...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2624");
  ...
  script_name("Huawei EulerOS: Security Advisory for libssh (EulerOS-SA-2025-2624)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2624");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2624");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libssh' package(s) announced via the EulerOS-SA-2025-2624 advisory.");
...
A flaw was found in libssh's handling of key exchange (KEX) processes when a client repeatedly sends incorrect KEX guesses. The library fails to free memory during these rekey operations, which can gradually exhaust system memory. This issue can lead to crashes on the client side, particularly when using libgcrypt, which impacts application stability and availability.(CVE-2025-8277)");
  ...
  script_tag(name:"affected", value:"'libssh' package(s) on Huawei EulerOS Virtualization release 2.13.1.");
...
if(release == "EULEROSVIRT-2.13.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libssh", rpm:"libssh~0.9.6~7.h7.eulerosv2r13", rls:"EULEROSVIRT-2.13.1"))) {
    report += res;
  }
