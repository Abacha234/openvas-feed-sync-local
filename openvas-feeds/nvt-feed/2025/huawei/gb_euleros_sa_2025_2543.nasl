...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2543");
  ...
  script_name("Huawei EulerOS: Security Advisory for httpd (EulerOS-SA-2025-2543)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2543");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2543");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'httpd' package(s) announced via the EulerOS-SA-2025-2543 advisory.");
...
Only configurations using 'SSLEngine optional' to enable TLS upgrades are affected. Users are recommended to upgrade to version 2.4.64, which removes support for TLS upgrade.(CVE-2025-49812)");
  ...
  script_tag(name:"affected", value:"'httpd' package(s) on Huawei EulerOS Virtualization release 2.13.1.");
...
if(release == "EULEROSVIRT-2.13.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"httpd", rpm:"httpd~2.4.51~20.h8.eulerosv2r13", rls:"EULEROSVIRT-2.13.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"httpd-filesystem", rpm:"httpd-filesystem~2.4.51~20.h8.eulerosv2r13", rls:"EULEROSVIRT-2.13.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"httpd-tools", rpm:"httpd-tools~2.4.51~20.h8.eulerosv2r13", rls:"EULEROSVIRT-2.13.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mod_ssl", rpm:"mod_ssl~2.4.51~20.h8.eulerosv2r13", rls:"EULEROSVIRT-2.13.1"))) {
    report += res;
  }
