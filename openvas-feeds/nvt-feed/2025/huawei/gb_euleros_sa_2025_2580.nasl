...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2580");
  ...
  script_name("Huawei EulerOS: Security Advisory for iputils (EulerOS-SA-2025-2580)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2580");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2580");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'iputils' package(s) announced via the EulerOS-SA-2025-2580 advisory.");
...
if(release == "EULEROSVIRT-2.13.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"iputils", rpm:"iputils~20221126~4.h5.eulerosv2r13", rls:"EULEROSVIRT-2.13.0"))) {
    report += res;
  }
