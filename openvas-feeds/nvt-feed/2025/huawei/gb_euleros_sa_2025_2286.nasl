...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2286");
  ...
  script_name("Huawei EulerOS: Security Advisory for gdb (EulerOS-SA-2025-2286)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2286");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2286");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'gdb' package(s) announced via the EulerOS-SA-2025-2286 advisory.");
...
if(release == "EULEROS-2.0SP13") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gdb", rpm:"gdb~11.1~8.h4.eulerosv2r13", rls:"EULEROS-2.0SP13"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gdb-headless", rpm:"gdb-headless~11.1~8.h4.eulerosv2r13", rls:"EULEROS-2.0SP13"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gdb-help", rpm:"gdb-help~11.1~8.h4.eulerosv2r13", rls:"EULEROS-2.0SP13"))) {
    report += res;
  }
