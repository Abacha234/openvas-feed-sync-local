...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2192");
  script_cve_id("CVE-2025-27613", "CVE-2025-48384");
  ...
  script_name("Huawei EulerOS: Security Advisory for git (EulerOS-SA-2025-2192)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2192");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2192");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'git' package(s) announced via the EulerOS-SA-2025-2192 advisory.");
...
if(release == "EULEROS-2.0SP11-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"git", rpm:"git~2.33.0~1.h18.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"git-help", rpm:"git-help~2.33.0~1.h18.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"perl-Git", rpm:"perl-Git~2.33.0~1.h18.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }
