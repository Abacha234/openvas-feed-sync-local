...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2242");
  ...
  script_name("Huawei EulerOS: Security Advisory for python3 (EulerOS-SA-2025-2242)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2242");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2242");
  script_xref(name:"URL", value:"https://docs.python.org/3/library/tarfile.html#tarfile-extraction-filter");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python3' package(s) announced via the EulerOS-SA-2025-2242 advisory.");
...
if(release == "EULEROS-2.0SP11") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3", rpm:"python3~3.9.9~7.h34.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-unversioned-command", rpm:"python3-unversioned-command~3.9.9~7.h34.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }
