...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2615");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-ldap (EulerOS-SA-2025-2615)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2615");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2615");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-ldap' package(s) announced via the EulerOS-SA-2025-2615 advisory.");
...
python-ldap is a lightweight directory access protocol (LDAP) client API for Python. In versions prior to 3.4.5, ldap.dn.escape_dn_chars() escapes \x00 incorrectly by emitting a backslash followed by a literal NUL byte instead of the RFC-4514 hex form \00. Any application that uses this helper to construct DNs from untrusted input can be made to consistently fail before a request is sent to the LDAP server (e.g., AD), resulting in a client-side denial of service. Version 3.4.5 contains a patch for the issue.(CVE-2025-61912)");
  ...
  script_tag(name:"affected", value:"'python-ldap' package(s) on Huawei EulerOS Virtualization release 2.13.0.");
...
if(release == "EULEROSVIRT-2.13.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-ldap-help", rpm:"python-ldap-help~3.3.1~5.h4.eulerosv2r13", rls:"EULEROSVIRT-2.13.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-ldap", rpm:"python3-ldap~3.3.1~5.h4.eulerosv2r13", rls:"EULEROSVIRT-2.13.0"))) {
    report += res;
  }
