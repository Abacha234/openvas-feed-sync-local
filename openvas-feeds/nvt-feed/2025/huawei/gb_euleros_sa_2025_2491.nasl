...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2491");
  ...
  script_name("Huawei EulerOS: Security Advisory for udisks2 (EulerOS-SA-2025-2491)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2491");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2491");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'udisks2' package(s) announced via the EulerOS-SA-2025-2491 advisory.");
...
if(release == "EULEROS-2.0SP11") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libudisks2", rpm:"libudisks2~2.9.4~2.h5.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"udisks2", rpm:"udisks2~2.9.4~2.h5.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }
