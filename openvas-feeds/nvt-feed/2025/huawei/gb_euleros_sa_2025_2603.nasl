...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2603");
  ...
  script_name("Huawei EulerOS: Security Advisory for vim (EulerOS-SA-2025-2603)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2603");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2603");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'vim' package(s) announced via the EulerOS-SA-2025-2603 advisory.");
...
if(release == "EULEROSVIRT-2.13.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"vim-common", rpm:"vim-common~9.0~23.h16.eulerosv2r13", rls:"EULEROSVIRT-2.13.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"vim-enhanced", rpm:"vim-enhanced~9.0~23.h16.eulerosv2r13", rls:"EULEROSVIRT-2.13.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"vim-filesystem", rpm:"vim-filesystem~9.0~23.h16.eulerosv2r13", rls:"EULEROSVIRT-2.13.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"vim-minimal", rpm:"vim-minimal~9.0~23.h16.eulerosv2r13", rls:"EULEROSVIRT-2.13.0"))) {
    report += res;
  }
