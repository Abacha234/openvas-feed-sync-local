...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2485");
  ...
  script_name("Huawei EulerOS: Security Advisory for libtiff (EulerOS-SA-2025-2485)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2485");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2485");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libtiff' package(s) announced via the EulerOS-SA-2025-2485 advisory.");
...
if(release == "EULEROS-2.0SP11") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libtiff", rpm:"libtiff~4.3.0~9.h31.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }
