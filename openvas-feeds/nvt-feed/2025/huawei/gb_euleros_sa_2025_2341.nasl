...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2341");
  ...
  script_name("Huawei EulerOS: Security Advisory for sqlite (EulerOS-SA-2025-2341)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2341");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2341");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'sqlite' package(s) announced via the EulerOS-SA-2025-2341 advisory.");
...
if(release == "EULEROS-2.0SP12-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sqlite", rpm:"sqlite~3.37.2~5.h8.eulerosv2r12", rls:"EULEROS-2.0SP12-x86_64"))) {
    report += res;
  }
