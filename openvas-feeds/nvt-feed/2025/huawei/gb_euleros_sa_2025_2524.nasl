...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2524");
  ...
  script_name("Huawei EulerOS: Security Advisory for libtiff (EulerOS-SA-2025-2524)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2524");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2524");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libtiff' package(s) announced via the EulerOS-SA-2025-2524 advisory.");
...
By providing an abnormally large image height value in the file's metadata, an attacker can trick the library into writing attacker-controlled color data to an arbitrary memory location. This memory corruption can be exploited to cause a denial of service (application crash) or to achieve arbitrary code execution with the permissions of the user.(CVE-2025-9900)");
  ...
  script_tag(name:"affected", value:"'libtiff' package(s) on Huawei EulerOS V2.0SP13.");
...
if(release == "EULEROS-2.0SP13") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libtiff", rpm:"libtiff~4.3.0~36.h12.eulerosv2r13", rls:"EULEROS-2.0SP13"))) {
    report += res;
  }
