...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2565");
  ...
  script_name("Huawei EulerOS: Security Advisory for sudo (EulerOS-SA-2025-2565)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2565");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2565");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'sudo' package(s) announced via the EulerOS-SA-2025-2565 advisory.");
  ...
  script_tag(name:"affected", value:"'sudo' package(s) on Huawei EulerOS Virtualization release 2.13.1.");
...
if(release == "EULEROSVIRT-2.13.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sudo", rpm:"sudo~1.9.8p2~15.h3.eulerosv2r13", rls:"EULEROSVIRT-2.13.1"))) {
    report += res;
  }
