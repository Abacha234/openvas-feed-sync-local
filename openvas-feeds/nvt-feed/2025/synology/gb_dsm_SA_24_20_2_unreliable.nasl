...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.125547");
  ...
  script_name("Synology DiskStation Manager (DSM) File Write Vulnerability (Synology-SA-24:20) - Unreliable Remote Version Check");
...
# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.125546
if ((version =~ "^6\.2\.4" && (revcomp(a: version, b: "6.2.4-25556") < 0)) ||
    (version =~ "^7\.1\.1" && (revcomp(a: version, b: "7.1.1-42962") < 0)) ||
