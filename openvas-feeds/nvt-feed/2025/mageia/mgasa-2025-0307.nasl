...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2025.0307");
  ...
  script_name("Mageia: Security Advisory (MGASA-2025-0307)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2025-0307");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2025-0307.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=34650");
  script_xref(name:"URL", value:"https://github.com/redis/redis/releases/tag/7.2.11");
  script_xref(name:"URL", value:"https://github.com/redis/redis/releases/tag/7.2.12");
  script_xref(name:"URL", value:"https://www.openwall.com/lists/oss-security/2025/10/07/2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'redis' package(s) announced via the MGASA-2025-0307 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A Lua script may lead to remote code execution. (CVE-2025-49844)
...
if(release == "MAGEIA9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"redis", rpm:"redis~7.2.12~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }
