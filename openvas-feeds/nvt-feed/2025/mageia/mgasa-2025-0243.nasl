...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2025.0243");
  ...
  script_name("Mageia: Security Advisory (MGASA-2025-0243)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2025-0243");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2025-0243.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=34645");
  script_xref(name:"URL", value:"https://www.openwall.com/lists/oss-security/2025/10/01/3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-django' package(s) announced via the MGASA-2025-0243 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An issue was discovered in Django 4.2 before 4.2.25, 5.1 before 5.1.13,
...
if(release == "MAGEIA9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-django", rpm:"python-django~4.1.13~1.7.mga9", rls:"MAGEIA9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-django", rpm:"python3-django~4.1.13~1.7.mga9", rls:"MAGEIA9"))) {
    report += res;
  }
