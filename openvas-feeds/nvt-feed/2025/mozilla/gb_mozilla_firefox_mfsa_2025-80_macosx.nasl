...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836693");
  ...
  script_name("Mozilla Firefox Security Update (mfsa_2025-80) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox prior to version 143.0.3 on
  Mac OS X.");

  script_tag(name:"solution", value:"Update to version 143.0.3 or later.");
...
if(version_is_less(version:vers, test_version:"143.0.3")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"143.0.3", install_path:path);
