...
if (description)
{
  ...
  script_name("Request Tracker (RT) 3.0.0 - 3.8.5 Session Fixation Vulnerability");
  ...
  script_tag(name:"summary", value:"Request Tracker (RT) is prone to a session fixation
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"Attackers can exploit this issue to hijack a user's session and
  gain unauthorized access to the affected application.");

  script_tag(name:"affected", value:"Request Tracker (RT) version 3.0.0 through 3.8.5.");
...
if (version_in_range(version: version, test_version: "3.0.0", test_version2: "3.8.5")) {
