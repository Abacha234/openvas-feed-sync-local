...
if(description)
{
  ...
  script_name("Oracle WebLogic Server Multiple Unspecified Vulnerabilities (cpujul2014, cpuapr2016)");
  ...
  script_xref(name:"URL", value:"https://www.oracle.com/security-alerts/cpujul2014.html");
  ...
  12.1.1.0, 12.2.1.0 and 10.0.2.0.");
