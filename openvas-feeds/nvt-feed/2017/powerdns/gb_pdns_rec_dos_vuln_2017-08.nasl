...
if(description)
{
  ...
  script_name("PowerDNS Recursor DoS Vulnerability (2017-08)");
  ...
  script_tag(name:"insight", value:"An issue has been found in the parsing of authoritative answers
  in PowerDNS Recursor, leading to a NULL pointer dereference when parsing a specially crafted
