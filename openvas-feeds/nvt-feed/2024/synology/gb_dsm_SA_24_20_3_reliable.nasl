...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.125548");
  ...
  script_name("Synology DiskStation Manager (DSM) File Disclosure Vulnerability (Synology-SA-24:20) - Remote Known Vulnerable Versions Check");
...
# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.125549
