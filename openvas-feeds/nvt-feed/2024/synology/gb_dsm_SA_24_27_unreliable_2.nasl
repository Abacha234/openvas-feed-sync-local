...
if(description)
{
  ...
  script_name("Synology DiskStation Manager (DSM) Privilege Escalation (Synology-SA-24:27)  - Unreliable Remote Version Check");
...
# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.138016
if ((revcomp(a: version, b: "7.2.1-69057") < 0) ||
    (revcomp(a: version, b: "7.1.1-42962") < 0) ||
