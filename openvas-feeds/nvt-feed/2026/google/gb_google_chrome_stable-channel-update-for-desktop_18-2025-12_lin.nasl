...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.837015");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_18-2025-12) - Linux");
  ...
  143.0.7499.169 on Linux");

  script_tag(name: "solution", value:"Update to version 143.0.7499.169 or
  later.");
...
if(version_is_less(version:vers, test_version:"143.0.7499.169")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"143.0.7499.169", install_path:path);
