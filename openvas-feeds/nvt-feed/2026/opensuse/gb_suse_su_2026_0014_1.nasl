...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2026.0014.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2026:0014-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"buildah", rpm:"buildah~1.35.5~150500.3.53.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
