...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.6100413910097102101");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-6d4139dafe)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-6d4139dafe");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-6d4139dafe");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'delve' package(s) announced via the FEDORA-2025-6d4139dafe advisory.");
  ...
  script_tag(name:"affected", value:"'delve' package(s) on Fedora 42.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"delve", rpm:"delve~1.26.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"delve-debuginfo", rpm:"delve-debuginfo~1.26.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"delve-debugsource", rpm:"delve-debugsource~1.26.0~1.fc42", rls:"FC42"))) {
    report += res;
  }
