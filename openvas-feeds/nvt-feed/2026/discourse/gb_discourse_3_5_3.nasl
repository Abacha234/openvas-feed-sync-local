...
if(description)
{
  ...
  script_name("Discourse < 3.5.3 Information Disclosure Vulnerability");
  ...
  script_tag(name:"affected", value:"Discourse prior to version 3.5.3.");
