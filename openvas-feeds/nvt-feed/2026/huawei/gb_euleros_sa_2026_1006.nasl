...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1006");
  ...
  script_name("Huawei EulerOS: Security Advisory for sqlite (EulerOS-SA-2026-1006)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1006");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1006");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'sqlite' package(s) announced via the EulerOS-SA-2026-1006 advisory.");
...
if(release == "EULEROSVIRT-2.10.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sqlite", rpm:"sqlite~3.32.3~2.h11.eulerosv2r10", rls:"EULEROSVIRT-2.10.1"))) {
    report += res;
  }
