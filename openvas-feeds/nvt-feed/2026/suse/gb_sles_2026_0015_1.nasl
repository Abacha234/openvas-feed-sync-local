...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0015.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0015-1)");
...
- CVE-2025-12764: improper validation of characters in a username allows for LDAP injections that force the processing
 of unusual amounts of data and leads to a DoS (bsc#1253477).");
  ...
  script_tag(name:"affected", value:"'pgadmin4' package(s) on SUSE Linux Enterprise Server 15-SP6, SUSE Linux Enterprise Server for SAP Applications 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pgadmin4", rpm:"pgadmin4~8.5~150600.3.18.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"pgadmin4-doc", rpm:"pgadmin4-doc~8.5~150600.3.18.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"system-user-pgadmin", rpm:"system-user-pgadmin~8.5~150600.3.18.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
