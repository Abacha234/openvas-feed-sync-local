...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0010.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0010-1)");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python311-tornado6", rpm:"python311-tornado6~6.3.2~150400.9.12.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python311-tornado6", rpm:"python311-tornado6~6.3.2~150400.9.12.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python311-tornado6", rpm:"python311-tornado6~6.3.2~150400.9.12.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
