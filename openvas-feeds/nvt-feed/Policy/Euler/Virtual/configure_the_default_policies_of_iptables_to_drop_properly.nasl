...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Virtual: EulerOS Virtual Linux Security Configuration (v1.0.0): 3. Running and Services: 3.2 Firewall: 3.2.1  Configure the Default Policies of iptables to DROP Properly (Recommendation)");
