...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Virtual: EulerOS Virtual Linux Security Configuration (v1.0.0): 2. Secure Access: 2.4 Access Control: 2.4.5 Ensure That Scripts Writable by Low-Privilege Users Cannot Be Configured in the sudoers Configuration File (Requirement)");
